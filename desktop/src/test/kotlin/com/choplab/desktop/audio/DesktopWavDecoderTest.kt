...
class DesktopWavDecoderTest {
    ...
    fun boundsDecodedNameBeforeProjectArchiveReadBack() {
        ...
        val audio = DesktopWavDecoder.readPcm(sourceName, stream, maximumFrames = 2)
    ...
    fun acceptsUnknownLengthStreamAtExactStreamingBoundary() {
        ...
        val audio = DesktopWavDecoder.readPcm("unknown.wav", stream, maximumFrames = 2)
    ...
    fun rejectsUnsupportedSampleRateBeforeReadingPayload() {
        ...
        assertFailsWith<IllegalArgumentException> {
            DesktopWavDecoder.readPcm("unsupported.wav", stream, maximumFrames = 1)
        }
