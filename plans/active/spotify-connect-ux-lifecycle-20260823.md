...
- Pixel receipt `work/device-evidence/20260823-025301-8306ed21/manifest.json` binds clean source `8306ed2` to serial `5A121JEBF08094`: data-preserving `adb install -r`, matching app/test APK hashes and signer, six instrumentation tests, three-generation autosave preservation, and foreground/rotation/volume restoration. A prior Android 16 activity-dump parser false stop was fixed and retained as a non-promoted failure receipt.
