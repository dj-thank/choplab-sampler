...
**wave 15 portfolio recompute / no slice selected:** Wave 14 closeoutをfresh-readし、次のbounded user outcomeを比較する。新しいsliceは、deterministic local falsifierと権限境界が固定されるまで開始しない。
