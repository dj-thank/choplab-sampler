...
**独立したDesktop永続化修正:** `a30a3a6`は`main@5430d0d`上でwindow/controller close時に900 ms debounce中の最終autosaveを失う競合を修正する限定follow-up。上記画面planの選択、archive schema、三世代recovery policyは変更しない。
