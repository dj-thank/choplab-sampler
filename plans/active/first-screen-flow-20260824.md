...
- Review-repair source: reachable commit `643546b5995c35b90c528f6ac5cc27ac8e737f0c`, tree `12d8f26cda24377ce6ad4631b3af8aff29b4ddcd`, whose ancestry includes typed-fixture repair `0659041`, two-parent product `23166b8` and exact `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the final follow-up commit only binds documentation to this source. Static policy 39/39, public-surface 396, six XML parses, all six exact #71 blobs, both exact #68 blobs, exact #65 transport/transport-test, exact #73 recorder runtime/test, controller step-zero preservation, new ownership/pointer/rotation regressions, deterministic double-tap-window settling and diff checks pass. Hosted compile/runtime checks are pending; the out-of-ancestry 43d8ace report is externally unverifiable historical context and supplies no current proof.
