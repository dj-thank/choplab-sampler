...
- Review-repair source: reachable commit `0659041c019d21b369d17efdcde17380d415f61d`, tree `bce74d2ccd7ed30f4b56a840d0babc119ac56d9d`, whose ancestry includes two-parent product `23166b8` and exact `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the final follow-up commit only binds documentation to this source. Static policy 39/39, public-surface 396, six XML parses, all six exact #71 blobs, both exact #68 blobs, exact #65 transport/transport-test, exact #73 recorder runtime/test, controller step-zero preservation, new ownership/pointer/rotation regressions, typed Compose pointer fixture and diff checks pass. Hosted compile/runtime checks are pending; the out-of-ancestry 43d8ace report is externally unverifiable historical context and supplies no current proof.
