...
- Review-repair source: reachable commit `20807ed6936435d16d4640d0fb00fa2abd50460a`, tree `9b99cd80d087af2951ec67234fd2e161e03244e4`, with exact `main@dfcd9d8871f34ca5ed125c9a1113c6a4dd612887` integrated in its ancestry; the final follow-up commit only binds documentation to this source. Static policy 39/39, public-surface 396, six XML parses, all six exact #71 blobs, both exact #68 blobs, exact #65 transport/transport-test, controller step-zero preservation, new ownership/pointer/rotation regressions and diff checks pass. Hosted compile/runtime checks are pending; the out-of-ancestry 43d8ace report is externally unverifiable historical context and supplies no current proof.
