...
- Review-repair source: reachable two-parent commit `ff41dcd9e0303399564ce00fcd565490ca46c906`, tree `de9cc7cbe9a394ede0c5aae1a8ed9f8069d9ca58`, integrating exact `main@3de1cc5de2fc950ee7e24dfac29a2bc926cf1553`; the final follow-up commit only binds documentation to this source. Static policy 39/39, public-surface 394, six XML parses and diff checks pass. Hosted compile/runtime checks are pending, so the exact 43d8ace artifacts remain historical rather than repair proof.
