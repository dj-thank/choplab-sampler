...
- Review-repair source: reachable two-parent commit `74f2cee837573fb193f1a23b004b8bebf798309a`, tree `385cafba8889c4c3f88dfb7abe0077882f75ea0b`, advancing prior PR head `b79f49d34120bea7d3cce34dc1b60c7753ef42ae` and exact `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the final follow-up only binds documentation. Static policy 39/39, public-surface 398, six XML parses, all six exact #71 blobs, exact #68 parity test plus retained terminal-sample behavior, exact #65 transport/transport-test, exact #73 recorder runtime/test, prior pointer/rotation regressions and new normal-touch/admission/sequencer/keyboard/failure regressions pass source/static checks. Hosted compile/runtime checks are pending; the out-of-ancestry 43d8ace report supplies no current proof.
