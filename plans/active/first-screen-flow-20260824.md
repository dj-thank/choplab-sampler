...
- Review-repair source: reachable two-parent commit `23166b80fbd3fe7c31fe9571a99a4344178a7b3e`, tree `fc5fbc9c5cdb2d5c4dc1c11a198e9e1e31fe59d8`, integrating exact main-side parent `a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the final follow-up commit only binds documentation to this source. Static policy 39/39, public-surface 396, six XML parses, all six exact #71 blobs, both exact #68 blobs, exact #65 transport/transport-test, exact #73 recorder runtime/test, controller step-zero preservation, new ownership/pointer/rotation regressions and diff checks pass. Hosted compile/runtime checks are pending; the out-of-ancestry 43d8ace report is externally unverifiable historical context and supplies no current proof.
