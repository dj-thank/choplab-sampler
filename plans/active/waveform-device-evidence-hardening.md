...
- `scripts/collect-device-evidence.ps1 -InstallAndTest -Serial 5A121JEBF08094` — exact run `20260816-184328-d01a299a`; build/install/readback/autosave/instrumentation/logcat/final-state evidence PASS.
- Pixel instrumentation — `OK (3 tests)` in `4.793 s`; app/readback SHA-256 `89E876A071043A6115A3BBEB091E071BB24BA54CBC7C0C640412741202383FD5`.
