...
- [x] 2026-08-17 — Source-bound commit `9177229` passed the final API 36 matrix: portrait font 1.0/1.3/2.0 and landscape each `OK (4 tests)`, fatal/ANR 0, Bluetooth fatal 0, settings readback restored, and ChopLab force-stopped. This promotes only COMPOSE_INSTRUMENTATION/FRAMEWORK_NODE.
...
- Dedicated AVD automation run — clean HEAD `9177229de91f2560b93f381fffda26909eaf4d75`, tree `2fe15415cef8a7a2907ea71ac840996a0d847e0b`; app SHA-256 `6178E499E53502AD6ABA0C16F2FE057015F795A305144417E8220097E3167909`; androidTest SHA-256 `EE34FA4EEF5CBC48FFCB708207464E27B34C8205462D4CAFDED54D9F08C1FFE0`; API 36 Google Play `emulator-5592`; portrait font 1.0/1.3/2.0 and landscape each `OK (4 tests)`; fatal/ANR 0; Bluetooth fatal 0; settings/process restoration PASS.
