...
- 2026-08-12 — physical Pixel 9a `5A121JEBF08094` updated in place from local-signed v0.9.0 to local-signed v0.9.3. Signers matched, private storage stayed 7 files / 169,513 KB, PC/device APK hashes matched, and fixed Beat UI smoke passed without microphone activation. Exact CI-signed public APK installation remains a separate unclaimed gate.
