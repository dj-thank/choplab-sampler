...
- [x] 2026-08-24 review follow-up — rebased onto `main@8fa1dac`, retained the count-resilient AVD result parser, and replaced absolute-deadline accumulation with realtime's carried-residual recurrence. Added early-event and terminal-WAV boundary regressions; hosted Kotlin execution remains required.
...
- Reachable review repair product `9ba2019` / tree `4b57329`, integrating `main@8fa1dac` — residual arithmetic fixes 18,600 vs 18,601 early event and 288,000 vs 288,001 one-bar boundary cases. Python 34, public-surface 394, arithmetic oracle and diff checks PASS; Gradle remains unavailable locally.
