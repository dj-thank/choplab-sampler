...
- [x] 2026-08-24 latest-main integration — preserved the four reviewed audio product/test files exactly on `main@a930da4`; fresh hosted execution remains required for the integrated head.
