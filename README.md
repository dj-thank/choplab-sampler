...
現在は、曲を流しながら16 PADを叩いてその瞬間を刻むライブチョップ、音声の取り込み、PAD別トーン、4 BANK、16ステップシーケンス、WAV書き出し、`.choplab`制作保存、二世代自動保存、40操作のUndo/Redoを備えたMVPと、次段階へ移行するためのステレオ対応ドメイン基盤を公開しています。GitHub Releasesには、タグから自動生成する開発プレビューAPKを添付します。
