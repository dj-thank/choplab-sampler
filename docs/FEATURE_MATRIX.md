...
| Android realtime PAD terminal retirement | 🧪 merged source / current PR CI待ち | original product `5dd3d66` / tree `c6a7e9b`はPR #68でmainへ統合済み。PR #58 product `20807ed` / tree `9b99cd8`もexact source/testを保持し、`main@dfcd9d8`の#65 transport readinessと#71 shared import-name境界も統合する。pooled PAD voiceの返却sampleをmixしてからfinished slotをdeactivateし、既存parity fixtureで403 frames、terminal PCM `-61`、retire後inactiveを固定。Python 39/39・public 396・diff PASS、PR #58 exact-head hosted Android gate待ち |
