...
## Current snapshot — 2026-09-02 Android audio merged / PR #69 scanner integration

GitHub `main@012b131784394b2fd641d580aaf4cd2d56b907f4` contains the H13 correction, stable Compose 1.11.1, v0.17.2 signer recovery, and Android audio-fidelity repair. The current sole-writer candidate integrates PR #69's exact artifact/history scanner before UI brush-up, release hardening, final-main verification, and the new immutable `v0.17.2` release attempt. Existing tags and the `v0.17.0` Release remain unchanged.

- PR #69 scanner checkpoints `e1306935312ce4e6bebe5600c972c6f0efd1c569`, `181701beeaa9d02f737f284e3fc92ce33e438ff2`, and fresh-review repair `baf70085eb572511df200d3b30b764c464e6e887` close AMR/token/PPK/M4A/Authenticode/NUL-history/traversal plus reachable commit-message, neutral historical binary, JKS certificate-body, and archive-valued metadata gaps while preserving every earlier bounded ZIP/APK/JIMAGE/SBOM control.
- Exact main-integration checkpoint `a5cfeac20b7f1062beeecbf8579b15f1e6e0a5a1` / tree `2f55b89aafa7f78284337c3edda107f107c8a3d0`: JDK 17 Gradle rerun executed 111/111 tasks: shared 87×2, Android 289, JVM core 88, Desktop 180, H13 24, Android lint/APK/AndroidTest compile, and Windows package all pass. Current scanner successor `baf7008` has full policy 195 with one Windows symlink-privilege skip, focused scanner 119, and current/history scans 483 each, failures 0.
- Runtime product subtrees are inherited from current main; PR #69 changes the public/history scanner, policy/workflow wiring, and evidence documentation only. No user audio, credential, tag, Release, device/provider account, or Human action is included.
