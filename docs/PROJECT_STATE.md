...
Local gate: configured offline validation PASS; 124 unit tests with zero failures/errors/skips; Android Lint PASS with zero errors and 11 advisories; debug assemble PASS; `git diff --check` PASS; UI scroll API scan zero matches. Version `0.11.0` (`versionCode=15`) local APK is 31,520,134 bytes with SHA-256 `699CD8EA834E3630A2994E32DCC925C4B4A0B7D970A3629AA09EDA59E924B580`; package `com.choplab.sampler`, minSdk 29, targetSdk 36, APK Signature Scheme v2, certificate SHA-256 `C0BE467A0F8010BED6F2687D1FDD138498E99B0401722C487459AEEDC453D587`.
