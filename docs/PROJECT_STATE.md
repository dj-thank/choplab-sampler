...
## Current snapshot — 2026-09-02 v0.17.2 signer-verifier recovery

The H13 Desktop long-press correction, accessibility readiness, and stable Compose 1.11.1 pin are merged on GitHub `main`. The immutable `v0.17.1` tag exposed a signer-output parsing gap before publication; current work is the bounded `v0.17.2 (29)` verifier recovery. The existing `v0.17.0` Release and both older tags remain unchanged.

- PR #83 merged as `2864117fe3c81b308033155dae337a6030165344`; PR #84 exact head `51238b1f29dc0c9bfb904d569fdf2081b23e56e3` passed hosted checks 8/8, fresh no-finding review, and six resolved threads before merge.
- Current GitHub base/main: `f6cbfdcc65584264ca7fd1cf7c450e9cab284b14` / tree `e91ae3dacf1d436f5697be149c21a458d1a639a6`. Its merged-main Android, Windows, iOS, and supply-chain workflows passed 4/4.
- Current H13 target is 24/24 (12 product UI interactions + 12 controller tests), Desktop is 180/180, Windows `installDist` passes, and Android framework-tree readiness remains covered. Compose 1.12's offscreen `RectManager` exception is not filtered; the merged source pins the proven 1.11.1 line.
- Annotated `v0.17.1` is tag object `20f1beeaf68bc88da9913bf059bcb2aff9a5dcd4`, peeled to `f6cbfdc`. Release run `33622584694` built/tests/lint/SBOM successfully but Android job `100222855379` failed before staging because the verifier could not parse a signer certificate SHA-256 label. No `v0.17.1` Release was published, and the tag will not be moved.
- Current repair: `cb7ba1fe6b8f40f0fc849d25d0953fd32e422bde` / tree `66b5cfd1acad5b05fa7ab956754db183d5b3d8a0`. The verifier hashes DER bytes from `apksigner --print-certs-pem`, cross-checks textual evidence, and fails closed on malformed/multiple/conflicting evidence. Embedded Gradle/XcodeGen identity is `0.17.2 (29)`.
- Local current results: new PEM cases 4/4, verifier 38/38, full policy 79/79, release metadata `v0.17.2`, public scan 481 with credential/signing/audio candidates 0, and actual 31,836,270-byte debug APK PEM-backed verification PASS (SHA-256 `82DB3518A3E5E5424706835AD8662843678D2FB28081758FE2EC9A13B512EAEF`).
- Public Release contract remains Android debug preview + unsigned iOS Simulator archive only; stable-signed Android and Windows app-image are verification-only. No public asset was downloaded for this work.
- Retained evidence: [PR #83 / #84 stabilization](../outputs/PR83-postmerge-accessibility-stability-20260902.md) and [v0.17.1 tag failure / v0.17.2 recovery](../outputs/v0.17.1-tag-failure-v0.17.2-recovery-20260902.md).
- Current selected execution plan: [H13 GitHub integration and release recovery](../plans/active/h13-github-release-20260902.md). Current code ceiling is `LOCAL_PASS` at `cb7ba1f`; PR/provider, new tag/Release, physical device/audio, Spotify account/provider, screen-reader speech, and Human gates remain separate.
