...
- Observed at: `2026-08-24T21:48:00+09:00`, after the immutable product commit and its static read-back were available.
- Source state: PR #52 merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`; PR #62, PR #65, PR #66, PR #67, PR #68, PR #70, PR #71 and the intervening bounded improvements are merged through exact `main@dfcd9d8871f34ca5ed125c9a1113c6a4dd612887`. The complete executable PR #58 repair is bound to reachable product commit `20807ed6936435d16d4640d0fb00fa2abd50460a`, tree `9b99cd80d087af2951ec67234fd2e161e03244e4`; its ancestry integrates exact `dfcd9d8`, and the final follow-up commit only binds documentation to that immutable source anchor. The integrated main side retains Desktop's shared 8–192 kHz import admission, mixes a pooled realtime PAD voice's terminal returned sample before retirement, publishes Desktop transport readiness before worker start so step zero cannot be discarded, and applies one shared nonblank 240 UTF-16-unit display-name boundary to Android provider/URI names and Desktop file names before PCM publication. A prior report names local build/runtime source `43d8ace6aa43f3eb6e3b9dc01ea74604ee600705` / tree `798212c33d1dcc3eb52ea79fb20e13b87a9b2d9a`, but that source is not in the current PR/main ancestry; its receipts are explicitly externally unverifiable historical context and establish no current gate.
