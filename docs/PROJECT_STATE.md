...
## Current snapshot — 2026-09-02 Windows UI / startup brush-up integration

GitHub `main@012b131784394b2fd641d580aaf4cd2d56b907f4` contains v0.17.2 signer recovery and Android audio fidelity. The current sole-writer lane integrates the reviewed Windows/UI brush-up while PR #69 scanner provider validation proceeds separately. Existing tags and the `v0.17.0` Release remain unchanged.
...
- Existing local gate before this main merge: shared 90, JVM core 88, Desktop 185, H13 24, Android unit 284, AndroidTest compile, policy 75, public scan, project validator and `packageWindows` PASS. The exact main-integration candidate must rerun these against current v0.17.2/audio bytes.
