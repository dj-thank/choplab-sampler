...
- Source state: branch `codex/desktop-autosave-close` integrates merged `main@6b645ca5005f905e93c572edfc1d375d4a6eeeb5`, including #62 constrained PAD gesture and semantics repair. The final documentation-only commit binds the immutable reachable product commit/tree; other worktrees remain untouched.
