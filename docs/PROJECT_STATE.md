...
- Source state: reachable integration product commit `d8a2b634e6043beeff846c4848a2ee56070c2592`, tree `365cf12ac1a080d1854c0508c1622e0b79bd1043`, with parents prior exact PR head `0a9def1816bffc903319b5358249f71b43f4c2cf` and merged `main@2786c3722a9e56fa299d2a88f009d882545b0768`. This candidate is not yet merged into main. Its four Desktop product/test blobs remain exact, and merged #66 timing, #67 Desktop import boundary and #68 realtime PAD retirement source/tests/docs are retained; the later evidence commit is documentation-only.
