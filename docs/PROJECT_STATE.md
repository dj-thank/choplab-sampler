...
- PR #69 scanner checkpoints `e1306935312ce4e6bebe5600c972c6f0efd1c569` and `181701beeaa9d02f737f284e3fc92ce33e438ff2` close the latest AMR, classic GitHub token, PuTTY PPK, extended-size M4A, PE Authenticode, NUL-safe Git history, and archive traversal review gaps while preserving every earlier bounded ZIP/APK/JIMAGE/SBOM control.
- Exact main-integration checkpoint `a5cfeac20b7f1062beeecbf8579b15f1e6e0a5a1` / tree `2f55b89aafa7f78284337c3edda107f107c8a3d0`: full policy 192 with one Windows symlink-privilege skip, focused scanner 116, current/history scans 483 each, failures 0. JDK 17 Gradle rerun executed 111/111 tasks: shared 87×2, Android 289, JVM core 88, Desktop 180, H13 24, Android lint/APK/AndroidTest compile, and Windows package all pass.
