...
- Observed at: `2026-08-24T12:06:02Z`.
- Source state: reachable integration product commit `99bd386dad7204dd5eec7d8d30cb6de0297b62a0`, tree `dec79d184ab72ee662c261b0b03f4c8cde9f3d34`, joins the repaired PR #64 lineage with merged `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`. The product tree preserves #65 Desktop transport readiness, #66 fractional timing, #67 Desktop import sample-rate admission, #68 Android realtime terminal-sample retirement and #70 Android import-name persistence; the final follow-up is documentation-only and binds this immutable source.
...
- Fresh local evidence after integrating `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`: 39 Python policy tests, public-surface scan over 394 candidates, conflict-marker scan and `git diff --check` pass. The two #65 transport-only files are byte-identical to merged main, and its controller/test changes are reconciled with the recovery repairs; #66/#67/#68/#70 source/tests remain inherited unchanged. The Gradle 9.7.1 distribution is not cached and its lock directory is not writable in this Linux environment, so the focused Desktop tests, full JVM gate and packaged Windows runtime remain hosted/local-machine verification boundaries.
