...
- Fresh review of `a1fdc80` found two documentary inconsistencies in this snapshot/registry and the feature-matrix count. This documentary successor repairs them; its own exact-head hosted checks, thread resolution, and fresh review remain the PR #84 merge gate.
...
- Current selected execution plan: [H13 GitHub integration and v0.17.1 release](../plans/active/h13-github-release-20260902.md). The current ceiling is PR/provider evidence for the pre-documentary head only; public binary, physical device/audio, Spotify account/provider, screen-reader speech, and Human gates remain separate.
