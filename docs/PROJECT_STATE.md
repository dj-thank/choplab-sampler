...
- Source state: reachable integration product `7c2ecbcc5f4aba9083a03f38905f6196913beaef`, tree `5aae213bff497ff124c2190f845df341bf21867d`, with parents reviewed-branch repair `15995a43f6c15debff150ebdd378997ff1bc6784` and exact merged `main@029500ac63fe521814530acf4d70cab78365c9fd`, tree `1ec604a2564ad39ff5c44d50f835d237c1ac6639`; the later evidence commit is documentation-only. ViewModel/recorder/recorder-test/session-test/session-reducer blobs are `8dc49a2` / `4b8413d` / `1780cba` / `a91ccc9` / `3a91cbb`.
