...
- Observed at: `2026-08-24T20:26:00+09:00`.
- Source state: PR #52 merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`; PR #62, PR #66, PR #67 and the intervening bounded improvements are merged through `main@3de1cc5de2fc950ee7e24dfac29a2bc926cf1553`. The complete executable PR #58 repair is bound to reachable two-parent product commit `ff41dcd9e0303399564ce00fcd565490ca46c906`, tree `de9cc7cbe9a394ede0c5aae1a8ed9f8069d9ca58`, whose main-side parent is exact `3de1cc5`; the final follow-up commit only binds documentation to that immutable source anchor. The integrated main side retains Desktop's shared 8–192 kHz import admission and rejects 192,001 Hz before payload reads. The prior built/runtime anchor remains `43d8ace6aa43f3eb6e3b9dc01ea74604ee600705`; its artifact receipts are not reused as proof for the repair.
