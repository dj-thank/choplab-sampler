...
- Local release-hardening receipt: [`outputs/release-hardening-20260903.md`](../outputs/release-hardening-20260903.md). Full policy 242 and current/history public scans 491 each pass; release metadata resolves to `0.17.2 (29)` / `v0.17.2`.
