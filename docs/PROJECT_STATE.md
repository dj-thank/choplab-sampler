...
This review surface updates the existing PR #78 from exact hosted receipt `8680fdbbc0a7346ec02fb958ad5b2dbac3254f6d`. Follow-up `a531f7be70358ec284bbc263a06dc17923cd8767` addresses the exact-head review by bounding Android document read-back to the expected byte count plus one, and this integration adds clean Wave 15 closeout `1deb8a9ec2198e88fcde07a572bf0a8f9eea333e`. It preserves merged `main@592b4ee777b32c9ce84d771166d04628cd104818` and all Waves 12–14 contracts.
...
- Current ceiling: clean parent receipts are inputs only. The merged result requires fresh focused/full local gates, policy/artifact read-back, integrated review and a new exact-head Android/Windows/iOS/supply-chain set before PR #78 can merge. Device/provider/signing/tag/binary Release/Human claims remain separate.
