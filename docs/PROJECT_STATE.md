...
## Current snapshot — 2026-09-02 v0.17.2 recovery merged / Android audio fidelity

The H13 correction, accessibility readiness, stable Compose 1.11.1 pin, and signer-verifier recovery are merged on GitHub `main`. The current sole-writer PR #86 candidate adds the user-requested Android audio-fidelity repair before PR #69, UI brush-up, release hardening, final-main verification, and a new immutable `v0.17.2` release attempt. Existing tags and the `v0.17.0` Release remain unchanged.
...
- PR #85 head `a7bf79fe790adff178e9dc3c0ed840ba2b489168` merged as current GitHub `main@e71e0fde2e8a7ef82020cfc905d07473b95c073b`. It advances Gradle/XcodeGen to `0.17.2 (29)` and verifies the signer from PEM DER rather than a presentation label. PR #86 follow-up `231da39e4c42b26d135bb3f5d7ce366fc6a540af` / tree `6ee130640e6c02228208b944627fcca5d8ff1605` also rejects multiple identical PEM blocks instead of deduplicating them. Exact merged-main/PR-head workflows remain separate read-back gates.
...
- Import/master hardening `9dc71a4652c943ded89c62bb50d9512270182d20`, DC/import-speed refinement `c5c5bcc692b947e684713f7a4e9b8c3762728f34`, and final invariant checkpoint `7e7c7ae5a5b30f7f3e526ba887825fe60b400fd1` / tree `b45b0d7f8afca04684e2149505cf4b3e869ef2ed` bind the actual AudioTrack output seam, reject unsupported/mid-stream PCM encoding changes and non-finite PCM, prevent DC-created clipping, and densely verify limiter monotonicity/symmetry.
- Exact JDK 17 local audio result at `7e7c7ae`: shared Desktop 87, shared Android host 87, Android unit 288, JVM core 88; failures/errors/skips 0. Android lint, debug APK assembly, and AndroidTest Kotlin compilation pass; 99/99 selected tasks executed under the documented bounded-memory configuration.
