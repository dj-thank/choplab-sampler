...
## Current snapshot — 2026-09-02 Windows UI integration after PR #69

GitHub `main@b737b17e76af68a7532de3cc6739018c1665b463` contains the H13 correction, stable Compose 1.11.1, v0.17.2 signer recovery, Android audio-fidelity repair, and PR #69's artifact/history scanner. PR #87 exact head `bb4ba8647395dda2d706a16b172ca7ff479f0f6a` is the immediate corrective follow-up for ten unresolved PR #69 review boundaries, hosted scanner findings, and the Windows close-test timeout. This sole-writer branch integrates the reviewed Windows/UI brush-up on top of that product line before release hardening and final-main verification. Existing tags and the `v0.17.0` Release remain unchanged.
...
- Scanner successor integration `e0a93678eb203954f8e18ebded964b90e51c04e0` / tree `9d33a999a8ffca717fb5848ae8a4bcdfd9449e67` passes full policy 210 and current/history scans 488 each. `app`, `shared`, `jvm-core`, `desktop`, root build and settings objects are byte-identical to the Gradle-verified `68296f2` checkpoint.
- PR #69 merged only scanner/policy/workflow/evidence changes; PR #87 adds complete historical-body classification, UTF-32, commit/tag header and per-message scans, ZIP symlink targets, PKCS#7-bound APK exemptions, V7 TAR and PKCS#12 controls. No user audio, credential, tag, Release, device/provider account, or Human action is included.
