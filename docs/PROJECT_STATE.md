...
- Observed at: `2026-08-24T21:13:00+09:00`, after the immutable product commit and its static read-back were available.
- Source state: PR #52 merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`; PR #62, PR #65, PR #66, PR #67, PR #68, PR #70 and the intervening bounded improvements are merged through `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`. The complete executable PR #58 repair is bound to reachable two-parent product commit `79c2a8bee5858641fcba14ea746e979c11c4b6c5`, tree `ba39013b5589bfe29eab2f77903641962df96acc`, whose main-side parent is exact `3072eedd`; the final follow-up commit only binds documentation to that immutable source anchor. The integrated main side retains Desktop's shared 8–192 kHz import admission, mixes a pooled realtime PAD voice's terminal returned sample before retirement, canonicalizes Android import display names to the archive's nonblank 240 UTF-16-unit ceiling before PCM publication, and publishes Desktop transport readiness before worker start so step zero cannot be discarded. A prior report names local build/runtime source `43d8ace6aa43f3eb6e3b9dc01ea74604ee600705` / tree `798212c33d1dcc3eb52ea79fb20e13b87a9b2d9a`, but that source is not in the current PR/main ancestry; its receipts are explicitly externally unverifiable historical context and establish no current gate.
