...
- Current selected execution plan: [H13 GitHub integration and product convergence](../plans/active/h13-github-release-20260902.md). The audio bytes are `LOCAL_PASS`; PR #85 main/provider, PR #86 exact-head, physical audio, Spotify provider, public binary, screen-reader speech, and Human gates remain separate until read back.
