...
- Local prototype: 4×4 PAD surface, local WAV open/play/stop, PAD assignment, JDK audio adapter.
...
- Local evidence: `:desktop:test` passed with 11 tests and `:desktop:packageWindows` passed on 2026-08-19. The resulting app-image launcher is `desktop/build/windows-app-image/ChopLab/ChopLab.exe` (449,024 bytes, SHA-256 `7F54213F5D17201BF4FA9CF05E7D5CB5AAD78AA3F76D1A0D6AD213CE4C56D49C`); it was started through the tracked-process wrapper and stopped by its exact PID after the smoke check.
