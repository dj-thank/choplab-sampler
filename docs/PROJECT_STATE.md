...
- PR-specific local evidence before this main merge: full policy 187 with one Windows symlink-privilege skip, focused scanner 116, current/history scans 479 each, failures 0. The exact main-integration result must rerun these plus Gradle/hosted gates before merge.
