...
GitHub `main@b737b17e76af68a7532de3cc6739018c1665b463` contains the H13 correction, stable Compose 1.11.1, v0.17.2 signer recovery, Android audio-fidelity repair, and PR #69's artifact/history scanner. PR #87 exact head `07f3ad987a4f3a844c1f838a0c18a67453602a5b` is the immediate corrective follow-up for ten unresolved PR #69 review boundaries and the hosted Windows close-test timeout. This sole-writer branch integrates the reviewed Windows/UI brush-up on top of that product line before release hardening and final-main verification. Existing tags and the `v0.17.0` Release remain unchanged.
...
- The pre-merge exact candidate at `4abe927` passed shared 91×2, Android 289, JVM core 88, Desktop 185, H13 24, Android lint/APK/AndroidTest compile, full policy/public scans, and `packageWindows`. The current integration must rerun the same gates after PR #69/#87.
