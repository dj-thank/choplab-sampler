...
- Observed at: `2026-08-24T20:57:00+09:00`, after the immutable product commit and its static read-back were available.
- Source state: PR #52 merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`; PR #62, PR #66, PR #67, PR #68, PR #70 and the intervening bounded improvements are merged through `main@333088147cdc77932efc41b90a08eb37e1c1cf42`. The complete executable PR #58 repair is bound to reachable two-parent product commit `c2e3aeea8d3cae18372b5ed99917eb95beb8d283`, tree `ec8702bc0f9350f90427a9d83a630105acb95dbe`, whose main-side parent is exact `33308814`; the final follow-up commit only binds documentation to that immutable source anchor. The integrated main side retains Desktop's shared 8–192 kHz import admission, mixes a pooled realtime PAD voice's terminal returned sample before retirement, and canonicalizes Android import display names to the archive's nonblank 240 UTF-16-unit ceiling before PCM publication. A prior report names local build/runtime source `43d8ace6aa43f3eb6e3b9dc01ea74604ee600705` / tree `798212c33d1dcc3eb52ea79fb20e13b87a9b2d9a`, but that source is not in the current PR/main ancestry; its receipts are explicitly externally unverifiable historical context and establish no current gate.
