...
- Executable proof: complete Python policy 100 tests passes with one explicit Windows-only symlink-fixture skip on a host lacking privilege. Current/history public scans pass over 465 candidates. Configured validation passes 18 tasks; JVM 88 / 9 suites and Desktop 165 / 24 suites have zero failure/error/skip.
