...
- Observed at: `2026-08-24T20:14+09:00`.
- Source state: reachable integration product commit `3e2cd38ff204d9067c6e6960a2a63e59e6cc32e7`, tree `01d1062120e3bc4438b5b5ac4a6b0132c0230d1d`, with parents prior exact PR head `1c4bf4c43edfeb2ecd71359851ed8df747575626` and merged `main@3de1cc5de2fc950ee7e24dfac29a2bc926cf1553`. This candidate is not yet merged into main. Its four Desktop product/test blobs remain exact, and merged #66 timing plus #67 Desktop import-boundary source/tests/docs are retained; the later evidence commit is documentation-only.
...
- Prior exact-head evidence: remote head `1c4bf4c43edfeb2ecd71359851ed8df747575626` received a clean exact-head Codex re-review and workflow runs `32719507840` (Android), `32719507923` (Windows), `32719507827` (iOS), and `32719507878` (supply chain) all completed successfully. The latest-main integration still requires its own hosted read-back.
