...
## Current snapshot — 2026-09-02 exact public ZIP content gate on v0.17.1 main

Current integration inputs are PR #69 security head `8a5218ed2f11dcbad2773c768b6f565fb44c1f2e` / tree `0175d124fbcf7a780433b0d74263609bcc43a73c` and merged `main@d3291a522699633d5b7426e4fff66ca4f7b55c09`. Main already contains PR #83 H13/v0.17.1, PR #82 setup-java v6, and repaired PR #80 Compose 1.12.0; its Android/Windows/iOS/Supply-chain push workflows are all green.

- Product preservation: runtime product subtrees come from `main@d3291a5`; PR #69 changes only the public/history scanner, its policy tests, release-asset gate, and evidence documentation.
- Broken security boundary: safe-named ZIP text and metadata were not scanned by current main. The PR parser covered current/history archives but still let attacker-declared LZMA dictionaries reach decoder construction before a memory cap, and applied compressed-input limits per member rather than to the whole archive.
- Resource repair: ZIP_LZMA dictionaries are capped at 16 MiB before decoder construction. Ordinary text retains 512 KiB/member and 4 MiB/archive input/output bounds; root ZIP/APK work is capped at 128 roots / 512 MiB compressed+expanded, nested work at depth 3 / 64 archives / 16 MiB member / 256 MiB aggregate. Git evidence has streaming output/change-record/direct-ref/tree-list bounds. `MemoryError` is fail-closed.
- Binary contract: non-APK binary bodies are fully CRC/size/EOF verified and byte-secret/audio scanned at 32 MiB/member under one recursive 384 MiB binary/JIMAGE budget. Exact JDK `runtime/lib/modules` is fully scanned up to 128 MiB after JIMAGE validation; `ct.sym` is recursively inspected under 20,000-entry/128 MiB inner caps. APK binary bodies share 32 MiB/member / 64 MiB/APK. `.app` main and bounded Skiko ICU are also full-body scanned. No magic, basename, JIMAGE-header-only or binary-suffix scan skip remains.
- Nested/alias reach: ZIP-compatible nested archives are detected behind prefixes/neutral suffixes; renamed gzip/bzip2/xz/7z/tar fails. BOM text, safe-name/ID3-less/binary-alias audio, raw Windows separators, non-commit tree/direct-blob refs and secret-shaped binary content are covered. Labels redact matched values.
- Exact consumer boundary: `--archive` scans staged/downloaded source, Android APK, Windows and iOS bytes; bounded `--text-file` scans the CycloneDX SBOM. Both build-android and final publication scan APK+SBOM before upload/manifest/attestation/publish. APK Signing Blocks require bounded pair structure and every pair value is secret/audio scanned.
- Executable proof after current-main conflict resolution: complete Python policy 173 tests passes with one Windows symlink-fixture privilege skip. The focused scanner suite is 102 tests. Current/history public scans pass over 479 candidates. Parent read-only verification classifies all nine latest review findings fixed; the conventional APK certificate and safe archive controls remain green.
- Exact artifact controls: source snapshot 1,542,548 / `F9B63B84A85A5D6336BE5C52FED5878DC6350AD20D09C3B3049015DA35C9B6A0`; signed Android APK 24,035,572 / `F8DCDBF5E7B13AF567F0388A5EFD885E61CFEA306F74AF590650DE677766772C`; Windows ZIP 89,156,340 / `7619DDE24822CC5CF6B38893382AC46DF8752AE777F046844E6322713F42AAA2`; iOS ZIP 318,236 / `5D17C8BD5E3DC6C359FED40F1B79B38CD901D53343735566201AA454BB72475C`; SBOM 1,581,101 / `413688DEDDBED53F235D311B7BE7B9472D6202B72ABD9F531D2EFA9D86A63DF2`; combined scan PASS.
- Review/gate: all received dictionary/resource/layout/nested/encoding/audio/ref/binary/JIMAGE/APK/SBOM/registry falsifiers have direct controls. Strongest fresh result is `LOCAL_PASS`; exact-head provider checks and review read-back must be refreshed on existing PR #69 after the current main integration. No tag/Release/device/provider-account/Human action is claimed by this snapshot.

## Historical snapshot — 2026-09-02 H13 / v0.17.1 integration

PR #83 merged as `2864117fe3c81b308033155dae337a6030165344`; PR #82 and repaired PR #80 subsequently advanced main to `d3291a522699633d5b7426e4fff66ca4f7b55c09`, whose four push workflows all passed. The historical steps below retain how that accepted H13 correction and v0.17.1 candidate were constructed; no `v0.17.1` tag or Release existed at this snapshot.
...
- Superseded pre-review candidate: `a7f4b08a1c891a67dd8879bd2007e71f5224774d` / tree `54cb789c445f384bbd1c20d3e596411340b36ccf`; its local receipt remains valid only for those earlier bytes.
- PR #83 review repair: product `260ad5e82e2bd79dbe3e168d455ef5d4280637eb` / tree `c3d2633f775cf86f14cda44bcf99dfcbc55fef3d` routes LOOP through the managed session, binds capture GATE release to exact ownership, keeps TRIM available on recoverable output failure while preserving fatal propagation, and synchronizes XcodeGen to `0.17.1 (28)`. Post-commit offline rerun: 27/27 tasks, 369 executions (359 unique), H13 20/20, policy 67/67, failure/error/skip 0, local Standards/Spec 0/0. See the [review-repair receipt](../outputs/PR83-review-repair-20260902.md). Hosted revalidation and review-thread resolution remain pending.
...
- PR #83 third review repair: product/repository `7b22b19fcc10da7cc9371bf72a9a933f79701680` / tree `37b718efe193b5ea8b9d0de4f56618cda69ade93` adds exclusive-loop candidate abort, one true top snapshot, current README/local gate, and clean-clone H13 evidence. Public-preview successor `acc13aa57dd8549f3f45180cef1136ddd8f6333e` / tree `de3922470ca40969c000c5d6a88b8e978fc11e7d` limits Release publication to Android debug + iOS while retaining signed Android/Windows verification. Policy 74/74, updated validator, focused loop tests, actual 0.17.1 debug APK build/verification, history scan, and local Standards/Spec 0/0 pass. Full local rerun is explicitly not claimed because the host paging-file boundary killed forked JVMs before a complete result. See the [third review-repair receipt](../outputs/PR83-third-review-repair-20260902.md). New-head hosted CI and six review threads remain pending.
- PR #83 fourth review repair: `6070204f9175ae9f09613eedaebc8c7e7a2b17f5` / tree `732f516e3b5d820f7ee0ef9c56f50063f7f2b759` corrects the public debug staging variable, gives the API 36 proxy a capture ownership token, and rejects unknown non-exported debug tooling. Policy 75/75, AndroidTest Kotlin compile 42 tasks, actual debug APK verification, history scan, and local review 0/0 pass. See the [fourth review-repair receipt](../outputs/PR83-fourth-review-repair-20260902.md). Hosted CI and three new review threads remain pending.
...
- User outcome: a new Windows Beat loop is admitted before audio work. The loop owner and every eligible vocal companion are prepared and started as one candidate set while prior source/PAD playback remains owned. Only complete startup retires prior Java Sound playback, stops transport/scratch, commits one project/history transition, publishes the loop owner/playhead and schedules autosave.
- Failure truth: loading or recording rejection does no audio work. Recoverable owner or companion preparation/start failure cancels the non-consuming edit plan, keeps transport/source/PAD runtime, PAD modes, revision, Undo/Redo and exact durable autosave bytes, and reports actionable status. Fatal or contract-external failure cancels then propagates without ordinary recoverable copy.
- Deep ownership: `ProductionEditPlan` is session-owned, epoch-bound and exact-once; `applyEdit` retains its existing behavior through plan+commit. Shared `beatLoopControlEnabled` keeps an active loop stoppable while disallowing a new start under loading/recording ownership. Existing exact GATE tokens and release targeting remain unchanged.
- Runtime ordering: `JavaSoundWavPlayer.startExclusiveLoopSession` starts all candidates before source/prior PAD retirement. Nonzero-CHOKE companions reduce to the final owner per group and cannot silence the selected owner. A controller lock plus split transport stop/join prevents a late step callback from introducing a voice during handoff; no Android realtime callback changed.
- Executable proof: focused shared Android/Desktop plus Desktop gate passes 333 tests / 58 suites. Final single-worker Android/shared/JVM/Desktop lint, assembly and Windows-package gate passes 184 tasks (150 executed / 34 up-to-date). XML read-back is Android 276 / 47 suites, shared Android 86 / 17, shared Desktop 86 / 17, JVM 88 / 9 and Desktop 163 / 24: 699 tests / 114 suites, failures/errors/skips 0. Lint debug/release each has fatal/error 0 / warning 4.
- Policy proof: Python policy 64/64, current and reachable-history public-surface 457 each, configured validator 18 tasks plus XML/executable/wrapper/UTF-8 checks, `git diff --check`, unsigned Android candidate positive and signed-required negative all pass. CycloneDX 1.6 verifies 650 components / 651 dependencies.
- Android artifacts: debug APK 31,803,506 / `BA96E55410DACE8B753F6C60600375429946069BDD4600404AA7C54399695BC8`; androidTest APK 10,996,855 / `F8AC9B2C1FC97672FCFB8565127D6099D80E906F49F623BE334C61AF102FE622`; unsigned release APK 24,274,036 / `D8165757CF4393DBCC808118D49585A23D5ACCB3237998BDE74620DF9D686AB5`. Version `0.17.0` / code 27 and `manifest_tool=apkanalyzer`; unsigned acceptance exits 0 and signed-required negative exits 1.
- Windows/SBOM artifacts: `ChopLab.exe` 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`; Desktop JAR 406,445 / `6659571F558CB832E9D88D21E8E9409A2EDB6370B912ADEA167026004EB25EE7`; app-image 405 files / 176,776,461 bytes / deterministic manifest `A98268B6A9F53ACA288D89811DDAEA66170795B113EBA84D06A1EF5160EFADC6`. SBOM JSON 1,581,101 / `D2C005FDA6DE4CEB9C4FC5A8EE3E58E6AD52FA1525EA5A1FEE9E0A98D6341389`, XML 1,431,320 / `DD8F19E237CC36C84430B6F2E3442FD4ED3612F8CB4D383B89F7D427E1D190F4`.
- Review: local parent two-pass Standards/Spec review first found missing direct actual-adapter ordering proof and incomplete ExecPlan structure. Proxy-Clip source/PAD ordering, companion-failure preservation, durable autosave-byte proof and required plan sections close both findings. Final unresolved findings are `0/0`.
- Execution boundary: two managed-sandbox full-gate attempts stopped at a readable Gradle-cache JAR with `AccessDeniedException`; the identical offline command passed outside that sandbox. No dependency download, real audio, device/ADB, provider/OAuth, push/PR, tag/Release, signing/secret or Human action occurred. Strongest fresh result is `LOCAL_PASS`; physical click/overlap/latency, endpoint removal, Narrator, Android realtime acknowledgement and all upper gates remain separate.

## Historical merged-main snapshot — 2026-08-27 Waves 12–16 GitHub integration candidate

Observed/read back at `2026-08-27T04:35:02+09:00`. Product merge `04a761c589f9370811b54224801064448def2951`, tree `12984c19307849012fade6dae538a5b3b74bbd63`, has parents Waves 12–15 receipt `9cca343fae45c74747a22eb04eca98ceb8c13543` and clean Wave 16 source `63092410f6f249d7b89c49393efe6cfbed349827`. It advances the existing PR #78 line without changing merged `main@592b4ee777b32c9ce84d771166d04628cd104818`, the immutable `v0.17.0` tag or the dirty canonical preservation checkout.

- Wave 16 contract: loading and every active recording phase deny Undo/Redo through one shared `HistoryRequestDenial` truth. Shared deck buttons, Windows native menu, Android controller, Windows controller and deep `ProductionSession` admission agree. Denial preserves project/history/revision/runtime/autosave while invalidating a stale unresolved history plan; idle Undo/Redo and Wave 15 same-owner loop continuity remain available.
- Additional integration control: a direct Windows controller request while loading preserves both the current project and history frontier. This complements the source branch's shared, Android, Desktop and deep history tests.
- Executable proof: focused merged tests pass in 59 tasks. The final single-worker Android/shared/JVM/Desktop lint, assembly and Windows-package gate passes in 184 tasks (39 executed / 145 up-to-date). XML read-back is Android 276 / 47 suites, shared Android 82 / 16, shared Desktop 82 / 16, JVM-core 88 / 9 and Desktop 148 / 24: 676 tests / 112 suites, failures/errors/skips 0. Lint debug/release each has fatal 0 / error 0 / warning 7.
- Policy proof: configured validation passes 18 Gradle tasks, six XML files, executable modes, wrapper SHA-256 and UTF-8 policy. Python policy passes 64/64. Current and reachable-history public-surface scans each accept 454 candidates and find no credential, signing or audio candidate. `git diff --check` passes.
- Android artifacts: debug APK 32,901,372 / `42E0987046F9790EB7A26DEFE9D1544B153892F07B09A1BA9A6D4861A28A86D1`; androidTest APK 11,173,354 / `147D47F27C8DF3CD488E29C1EA682B5F85E73837DB0FB084375314C968B4D358`; unsigned release APK 24,274,036 / `2A25D94847AC0A1F6D0842B9F9E893EDF1DCF53FAA213B08E22A23174E7976C7`. Version `0.17.0` / code 27 and `manifest_tool=aapt2` verify; unsigned-candidate acceptance exits 0 and signed-required negative exits 1.
- Windows/SBOM artifacts: `ChopLab.exe` 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`; Desktop JAR 393,533 / `61C619DDBD791A774C4B9F2CCA3051025D7A2917C6AD00FABEED2C211B8508F0`; app-image 405 files / 176,760,428 bytes / deterministic manifest `8B161FD1604F7ABC26D059292E772EDEA068C9FEFCAFE5B959697345812600E2`. CycloneDX 1.6 verifies 650 components / 651 dependencies; JSON 1,581,101 / `9FB3E143B2BF5A38C3BA0B16586AF308024B4ED9B5BCD238CA52179BFAA93D59`, XML 1,431,320 / `8E6311F678C261C7CF31E2331012CDA5B733165FF23BEEF6B222A1A0B9FB9A2B`.
- Integrated review: Standards and Spec unresolved findings are `0/0`. The former non-terminating provider read-back review finding remains fixed and bounded at `expected + 1` bytes; candidate-first loop/history transaction, exact ownership/epoch checks and all prior negative controls remain connected.
- Current ceiling: exact merged bytes establish `LOCAL_PASS`. A new exact-head Android/Windows/iOS/supply-chain set, clean mergeability and resolved review threads are still required before PR #78 can merge. Device/provider/signing/tag/new binary Release/Human claims remain separate; immutable `v0.17.0` is not rewritten and a current binary release requires an explicit new version/tag.

## Historical integration snapshot — 2026-08-27 Waves 12–15 GitHub integration candidate

Observed/read back at `2026-08-27T04:12:13+09:00`. Product merge `37312af8c502621077c3a01c569dc4d797efbff5`, tree `a9a1e0715cf8b8105c0d1fd054b70bada6c0218f`, has parents reviewed read-back fix `a531f7be70358ec284bbc263a06dc17923cd8767` and clean Wave 15 closeout `1deb8a9ec2198e88fcde07a572bf0a8f9eea333e`. It updates the existing PR #78 line from hosted receipt `8680fdbbc0a7346ec02fb958ad5b2dbac3254f6d`, preserves merged `main@592b4ee777b32c9ce84d771166d04628cd104818` and retains every Waves 12–14 contract.

- Review fix: an oversized or non-terminating provider stream is rejected at the first provable extra byte instead of waiting for EOF. A bounded endless-stream test first reproduced the old 64 KiB over-read and now passes with exactly `expected + 1` bytes consumed.
- Wave 15 contract: same-owner active-loop Undo/Redo previews shared history, keeps an unchanged voice or starts a replacement candidate, and consumes history only after candidate success. Recoverable startup failure preserves project, voice, owner, revision and history frontier.
- Executable proof: focused merged Android/shared/JVM/Desktop tests pass in 59 tasks. The final single-worker Android/shared/JVM/Desktop lint, assembly and Windows-package gate passes in 184 tasks (35 executed / 149 up-to-date). XML read-back is Android 276 / 47 suites, shared Android/Desktop 77/77 / 15+15, JVM-core 88 / 9 and Desktop 145 / 23: 663 tests / 109 suites, failures/errors/skips 0. Lint debug/release each has fatal 0 / error 0 / warning 7.
- Policy proof: configured validation passes 18 Gradle tasks, six XML files, executable modes, wrapper SHA-256 and UTF-8 policy. Python policy passes 64/64. Current and reachable-history public-surface scans each accept 450 candidates and find no credential, signing or audio candidate. `git diff --check` passes.
- Android artifacts: debug APK 32,242,280 / `83AF5A0E5FD14E824CB73DC8A08ADA9221037E37503ACB9032FBBA3449C07E2F`; androidTest APK 11,173,354 / `147D47F27C8DF3CD488E29C1EA682B5F85E73837DB0FB084375314C968B4D358`; unsigned release APK 24,274,036 / `91E0185604BD4A365AB66BEEE1722C314964621F5FF38D0333C2A949963E7EAE`. Version `0.17.0` / code 27 and `manifest_tool=aapt2` verify; unsigned-candidate acceptance exits 0 and signed-required negative exits 1.
- Windows/SBOM artifacts: `ChopLab.exe` 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`; Desktop JAR 391,090 / `80DD0AB3C92E956E7BD25A1458EB2FC0ABCD4971FD270C5783206D9B55E038FF`; app-image 405 files / 176,755,548 bytes / deterministic manifest `3BFA469B8E1D5A9AE1C6E1DC977ADC9139C6FAB20F9DF88FCEE09D7BC424C9F3`. CycloneDX 1.6 verifies 650 components / 651 dependencies; JSON 1,581,101 / `9FB3E143B2BF5A38C3BA0B16586AF308024B4ED9B5BCD238CA52179BFAA93D59`, XML 1,431,320 / `8E6311F678C261C7CF31E2331012CDA5B733165FF23BEEF6B222A1A0B9FB9A2B`.
- Integrated review: Standards and Spec unresolved findings are `0/0`. Candidate-first voice replacement, operation epochs, exact per-voice ownership, atomic sibling publication, bounded Android provider read-back and history-plan owner/epoch/exact-once checks all remain connected; recoverable exceptions and fatal errors remain separated.
- Current ceiling: exact merged bytes establish `LOCAL_PASS`. A new exact-head Android/Windows/iOS/supply-chain set, clean mergeability and resolved review thread are still required before PR #78 can merge. Device/provider/signing/tag/binary Release/Human claims remain separate; immutable `v0.17.0` is not rewritten.

## Historical local snapshot — 2026-08-27 Windows active-loop history transaction

This is the current local product truth for wave 15. A reversible Windows PAD edit no longer forces a still-owned Beat loop to stop merely because the user chooses Undo or Redo.

- Observed/read back at: `2026-08-27T03:54:42+09:00`.
- Product source: `codex/choplab-loop-history-transaction-20260827@70b31e949a9faa42d0f459f2d03218d16e6e30b7`, tree `ce9469cdf37b6620c8b5c428fa479e9361194d1b`, based on Wave 14 closeout `924fb3c05697fb1ff801d3dba7fb1a77ee8c29dc`. The dirty canonical preservation checkout and separate conflicted integration checkout remain untouched.
- User outcome: when current and target snapshots retain the same assigned Beat-loop owner, Undo/Redo keeps an unchanged owner PAD audible without retriggering it. If that PAD's trim, reverse, pitch, tone, gain, mode or CHOKE data changes, Windows starts the restored PAD as a `forceLoop` replacement candidate and commits history only after startup succeeds.
- Deep boundary: `ProductionHistoryPlan` previews one Undo/Redo target without consuming it. Plans are session-owned, epoch-bound and exact-once; cancel leaves history and revision unchanged, stale/cross-session/resolved plans are rejected, and the existing synchronous `undo`/`redo` APIs use the same lifecycle for Android compatibility.
- Runtime boundary: continuity is admitted only for the same assigned owner with unchanged source audio/master pitch and no active source, transport or scratch state. A removed/different owner or unsupported runtime combination commits through the existing disruptive `applyHistoryState` path. Replacement resets playhead truth to the restored forward start or reverse end; an unchanged PAD preserves the observed runtime playhead.
- Failure truth: a recoverable candidate exception cancels the plan and keeps the edited PAD, current voice, loop owner, Undo/Redo frontier, revision and autosave admission unchanged while reporting that the operation was not applied. Fatal `Error` is rethrown without status rewriting or history consumption. A later valid attempt can still commit.
- Companion boundary: this slice neither starts nor retires vocal companion voices during same-owner history continuity. Existing loop-start and CHOKE-session policies remain unchanged; companion reconfiguration and cross-owner/cross-mode atomicity are not claimed.
- TDD/review: missing `planUndo`/`planRedo`/history-plan APIs produced the intended compile RED. GREEN covers preview/cancel/commit, exact-once/stale/cross-session rejection, changed and unchanged PADs, Undo→Redo, recoverable Undo/Redo failure, fatal passthrough and owner-removal fallback. Two fixture assumptions exposed that starter B-01 begins with step 0 and LOOP PADs reject pattern steps; the no-retrigger control was corrected to edit a different one-shot PAD. Final unresolved Standards/Spec findings are `0/0`.
- Validation: clean full gate `BUILD SUCCESSFUL in 3m55s`, 197 tasks (195 executed / 2 up-to-date). Android app 265 / 46 suites, shared Android/Desktop 69/69 / 13+13 suites, JVM-core 81 / 9 suites and Desktop 109 / 22 suites: 593 tests / 103 suites, failures/errors/skips 0. Lint debug/release each: fatal 0, errors 0, warnings 7. Configured validation 18 tasks and product-checkpoint public surface 444 PASS; closeout Python policy 59, current plus reachable-history public surface 445 and `git diff --check` PASS.
- Artifact read-back: debug APK 31,721,586 / `8CD10DF4060A13F8EF7FE444A711FC040C02D6F53DC14431DC2AD40A28265AD6`; androidTest APK 10,878,659 / `19002E0EBB2B62B599FAE7CF1738AC275B7D4CBEC610F0348D3B9C871A90E4AC`; unsigned release APK 24,224,884 / `B13EE2794AD8048A918DF6D7A7EC6CBB569E2151E0B373D2E520562CD73A81F8`; Desktop JAR 352,656 / `AE31D186132A4039DF0AB8831EE959D07AF681EB0D90FE16BD820D96D38A8F15`; Windows EXE 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`.
- Release/package policy: the exact unsigned APK passes package/version, manifest allowlists, non-debuggable, exported-component, 16-KiB alignment and `manifest_tool=aapt2` inspection. `--require-signed` rejects it with exit 1 as expected. Windows app-image is 405 files / 176,664,783 bytes with sorted slash-path/size/lowercase-file-hash manifest SHA-256 `4EE29D2883A034B880ED88E5B63F2857448B40A8F568F8CF7CAF39E8DC0C62F1`. CycloneDX 1.6 JSON verifies as `com.choplab:ChopLab:0.17.0`, 650 components / 651 dependencies; JSON is 1,581,101 bytes / `A86D110C9B4DC5EE8FF624394D679FBA4CEF1B6A4A2F4DC55D1147B7D645B836`, XML is 1,431,320 bytes / `80F089913D2A51FF326468239861D824E860741E2F4E3998CCBEB5719F2366ED`. The existing verifier accepts JSON only; XML is build/hash evidence, not a second parser verdict.
- Review/portfolio: parent PAD `work/PAD_CHOPLAB_GOAL_PORTFOLIO_WAVE15_20260827.md` and `work/PAD_CHOPLAB_GOAL_WAVE15_REVIEW_20260827.md`.
- Scope/gate: no dependency/model/package download, real audio asset, signing identity, key, secret, workflow, GitHub/Release, OAuth/provider, ADB/device or Human action occurred. Strongest fresh result is `LOCAL_PASS`; actual endpoint continuity, click/pop/brief overlap/latency, driver removal, Bluetooth/sleep/resume, Narrator and `DEVICE_PASS` / `PROVIDER_PASS` / `PUBLIC_PASS` / `HUMAN_GO` remain separate.

## Historical integration snapshot — 2026-08-27 Waves 12–14 GitHub integration candidate

This review surface updates the existing PR #78 from receipt `aab28763c8a44bee2e778578f17d11cf52075fb6`. Immutable product merge `5495ed1780eea69e4a3f7d25c57cdda5714ac602`, tree `0ec045e93694dc5182e364ebc836e1c18e7bb69d`, has parents that exact prior receipt and clean Wave 14 closeout `924fb3c05697fb1ff801d3dba7fb1a77ee8c29dc`. It therefore preserves merged `main@592b4ee777b32c9ce84d771166d04628cd104818`, Wave 12 candidate-first Windows loop replacement and Wave 13 atomic Windows WAV publication while adding Wave 14 verified Android document publication.

- Conflict contract: retain the dedicated status-operation epoch, exact per-voice ownership, injected Clip factory and candidate-first replacement from the prior integration. Also retain Wave 14 cancellation propagation and verified provider copy/read-back binding. Recoverable controller failures catch `Exception` only; fatal `Error` remains unconverted.
- Publication contract: Android success is emitted only after the selected URI reopens and matches the closed app-owned temporary by byte count and SHA-256. This is a verification boundary, not a provider atomic-replace or rollback guarantee.
- Fresh local proof: focused integration tests pass in 51 tasks. The controlled full Android/shared/JVM/Desktop lint, assembly and Windows-package gate passes in 184 tasks; XML read-back is 651 tests / 109 suites with failures/errors/skips 0, and lint debug/release each has fatal 0 / error 0 / warning 7. Four Desktop 2-second async waits first timed out only while competing Android work ran; all four passed immediately in isolation and the complete single-worker full gate passed, so the incident remains recorded rather than hidden.
- Policy and artifacts: configured validation passes 18 tasks, Python policy 64/64 and current plus reachable-history public-surface 449. The unsigned Android candidate passes version/manifest/security/alignment policy while the signed-required negative exits 1. Windows app-image is 405 files / 176,747,758 bytes; CycloneDX 1.6 verifies 650 components / 651 dependencies. Standards/Spec unresolved findings are `0/0`.
- Current ceiling: the merged bytes establish `LOCAL_PASS`. PR #78 still requires fresh Android/Windows/iOS/supply-chain success on one exact final head plus a clean, mergeable read-back before merge. No device, provider, signing, tag, binary Release or Human claim is inherited.
- Release boundary: source metadata remains `0.17.0` / code `27`, while immutable tag `v0.17.0` names older bytes. This integration does not rewrite that tag or publish a binary; a later Release requires an explicit new version/tag decision.

## Historical local snapshot — 2026-08-27 verified Android document publication

This was the clean Wave 14 local-branch product truth before GitHub integration. Android reports WAV or portable-project publication success only after the selected document reopens and matches the validated app-owned source byte-for-byte.

- Observed/read back at: `2026-08-27T03:12:59+09:00`.
- Product source: `codex/choplab-verified-document-publication-20260827@60068369e9c2820509a839c259693ae0ce2bac2d`, tree `e7b7643ddade8d54aed421c4c01597d2d1722cf8`, based on Wave 13 closeout `9043af2f582b4f8965ce973ab007d79de4d9324b`. The dirty canonical preservation checkout and separate integration checkout remain untouched.
- User outcome: Android WAV export and portable-project save stream their closed, app-owned temporary into the selected URI, close the output, then reopen the destination and require the same byte count and SHA-256 before publishing success. Silent truncation, same-size corruption, extra bytes, provider open/write/read/close failure or unverifiable read-back produces a truthful non-success message while the in-app production or internal project safety copy remains available.
- Deep boundary: `publishVerifiedDocument` uses a bounded 64 KiB buffer, handles a zero-progress bulk read without spinning, compares digests in constant time and exposes only success or a typed recoverable publication failure. Missing source is rejected before destination output is opened. Cancellation is rethrown and fatal `Error` is not converted into ordinary failure.
- Android ownership: WAV and project flows use unique cache temporaries and best-effort cleanup in `finally`. Project codec read-back and internal autosave still precede provider publication. Render/DSP, project schema and Windows atomic behavior are unchanged.
- Provider boundary: exact-byte reopen is not an atomic replace, transaction or rollback guarantee. A provider may expose partial destination bytes after failure, reject immediate reopen or change consistency over time; restoration of a previous selected document is not claimed.
- TDD/review: missing publisher and shared failure-copy APIs produced compile REDs. GREEN covers exact multi-buffer/empty copies, truncation/corruption/extra bytes, null output/read-back, missing source, write/read/close failure, zero-progress input, cancellation and fatal controls. Standards review removed an unused public fingerprint result; final unresolved Standards/Spec findings are `0/0`.
- Validation: clean full gate `BUILD SUCCESSFUL in 3m50s`, 197 tasks (196 executed / 1 up-to-date). Android app 265 / 46 suites, shared Android/Desktop 66/66 / 13+13 suites, JVM-core 81 / 9 suites and Desktop 104 / 22 suites: 582 tests / 103 suites, failures/errors/skips 0. Lint debug/release each: fatal 0, errors 0, warnings 7. Configured validation 18 tasks and product-checkpoint public surface 443 PASS; closeout Python policy 59, current plus reachable-history public surface 443 and `git diff --check` PASS.
- Artifact read-back: debug APK 31,721,586 / `51974214AEFF95BC7DE3D666308E53A9D3E52975074537D4EB2AD5680F5202F5`; androidTest APK 10,878,659 / `19002E0EBB2B62B599FAE7CF1738AC275B7D4CBEC610F0348D3B9C871A90E4AC`; unsigned release APK 24,224,884 / `D5CE2B5EE7051B880B55553B690196BB339D253C16BAC9AEB04D094DF588E692`; Desktop JAR 349,674 / `C4B2F22F74F0FC4C1AE4126B80FAA92728898E9897213A71274008266EC32DC9`; Windows EXE 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`.
- Release/package policy: the exact unsigned APK passes package/version, manifest allowlists, non-debuggable, exported-component, 16-KiB alignment and `manifest_tool=aapt2` inspection. `--require-signed` rejects it with exit 1 as expected. Windows app-image is 405 files / 176,657,157 bytes with sorted slash-path/size/lowercase-file-hash manifest SHA-256 `A941FD50C0BEDADA4A419F22F15AF0331D6EFDFD011B072DB6233CBE6B1A0AFC`. CycloneDX 1.6 JSON verifies as `com.choplab:ChopLab:0.17.0`, 650 components / 651 dependencies; JSON is 1,581,101 bytes / `AD8E0022CF0376B3DA972B821804122CE7C3665D064A04214F46DCB6416FA5FE`, XML is 1,431,320 bytes / `4BAD93472E047B342E4468A094EB2F7D3A64D2189C0B12038DDC431A9A113964`. The existing verifier accepts JSON only; the XML is build/hash evidence, not a second parser verdict.
- Review/portfolio: parent PAD `work/PAD_CHOPLAB_GOAL_PORTFOLIO_WAVE14_20260827.md` and `work/PAD_CHOPLAB_GOAL_WAVE14_REVIEW_20260827.md`.
- Scope/gate: no model/package download, real audio asset, signing identity, key, secret, workflow, GitHub/Release, OAuth/provider, ADB/device or Human action occurred. Strongest fresh result is `LOCAL_PASS`; real DocumentsProvider reopen timing/consistency, existing-document partial state, network/offline/process-death behavior, `DEVICE_PASS`, `PROVIDER_PASS`, `PUBLIC_PASS` and `HUMAN_GO` remain separate.

## Historical integration snapshot — 2026-08-27 Wave 12/13 GitHub integration candidate

This review surface starts from merged `main@592b4ee777b32c9ce84d771166d04628cd104818` and merges the clean Wave 13 closeout `9043af2f582b4f8965ce973ab007d79de4d9324b`, which contains Wave 12. It keeps PR #58's hosted-repaired focused editor, stale-operation separation, exact GATE ownership and all earlier integrated product lines while adding candidate-first Windows loop replacement and overwrite-safe Windows WAV publication.

- Immutable integration product: `cc4199f0c17ededfd3847ba0ffc14f0c0bdbc4c8`, tree `0ab9a9ca90885b9d3e77f44e434d81da2aff22ad`, with parents merged `main@592b4ee777b32c9ce84d771166d04628cd104818` and Wave 13 closeout `9043af2f582b4f8965ce973ab007d79de4d9324b`. Source inputs include PR #58 receipt `5ecd5efc4357a76586ea5607413864c8b63989a1`, Wave 12 product `b8db4368511d8dd3578634bdd071be0da0f38b8a` and Wave 13 product `ffe1bbdf59d0645652c3f8556fb6f601e5218670`.
- Conflict contract: async export completion stays on the dedicated status-operation epoch and catches recoverable `Exception` only. Desktop loop edits start a candidate voice before state/history/autosave commit. Java Sound retains injected Clip creation and exact per-voice ownership while preparing/starting the replacement before retiring same-PAD or CHOKE conflicts.
- Fresh local integration proof: focused shared/JVM/Desktop gate passes in 23 tasks. The full Android/shared/JVM/Desktop lint, test, assembly and Windows package gate passes in 184 tasks. XML read-back is Android 275 / 47 suites, shared Android/Desktop 74/74 / 15+15, JVM-core 74 / 8 and Desktop 140 / 23: total 637 tests / 108 suites with failures/errors/skips 0. Lint debug/release each has fatal 0 / error 0 / warning 7.
- Policy/artifacts: configured validation 18 tasks and Python policy 64 pass. Current plus reachable-history public surface accepts 446 candidates with no credential, signing or audio candidate. Android debug, androidTest and unsigned release APKs remain exact at `F798F68C...022B`, `147D47F2...D358` and `09EBE02B...E4F`; the unsigned release passes manifest/security/alignment policy and the signed-required negative exits 1. Desktop JAR is 388,159 bytes / `3982FF58D89F567CC7AC12D766FB9B311FBFF007264E231BEA4D044AC121C043`; Windows app-image is 405 files / 176,741,639 bytes / manifest `BD526293885A61EBC5AF00EF2263DF9D7F52C21633A17596F9EE68F7975084B2`. CycloneDX 1.6 is 650 components / 651 dependencies, 1,581,101 bytes / `9FB3E143B2BF5A38C3BA0B16586AF308024B4ED9B5BCD238CA52179BFAA93D59`.
- GitHub base proof: PR #58 exact receipt `5ecd5ef` passed 8/8 PR/push checks, including API 36 29/29, and merged as `main@592b4ee`. That main commit then passed Android `32998169318`, Windows `32998169330`, iOS `32998169352` and supply-chain `32998169317`. The new integration product still requires its own exact-head hosted set before merge.
- Review/gate: parent-only Standards and Spec passes have unresolved findings `0/0`. Strongest current result is `LOCAL_PASS` plus the prior exact base's scoped GitHub `PUBLIC_PASS`; no physical endpoint/audio, Android SAF provider, accessibility speech, signing, new binary publication or `HUMAN_GO` is inferred.
- Release boundary: source metadata remains `0.17.0` / code `27`, while immutable tag `v0.17.0` points to older bytes. This integration does not rewrite the tag or publish a binary; a later Release requires an explicit new version/tag decision.

## Historical local snapshot — 2026-08-27 overwrite-safe Windows WAV export

This was the clean Wave 13 local-branch product truth before GitHub integration. It prevents a failed Windows Beat export from truncating or replacing an existing completed WAV, without changing audio content or Android provider behavior.

- Observed/read back at: `2026-08-27T02:42:44+09:00`.
- Product source: `codex/choplab-atomic-wav-export-20260827@ffe1bbdf59d0645652c3f8556fb6f601e5218670`, tree `d3ae7a9bb18d48ae323e92aaabfe58e25acd975f`, based on Wave 12 closeout `6fb1c94f283019580d0cbf0fecfadeefa324675a`. The dirty canonical preservation checkout and separate conflicted integration checkout remain untouched.
- User outcome: Windows renders into a unique same-parent temporary, validates the closed canonical PCM-16 RIFF/WAVE shape against the render summary, forces the temporary file and only then atomically replaces the selected destination. Render/write/close/shape/move failure keeps an existing WAV byte-identical and removes the owned temporary; a failed first export leaves no destination.
- Filesystem boundary: an existing target is never routed through a non-atomic overwrite fallback. If the filesystem cannot atomically replace it, export fails closed. An absent target may use a same-filesystem no-replace move, so a concurrent new file is not overwritten. Directory sync is best effort after publication.
- Shared persistence: manual `.choplab` save now uses the same deep sibling-replacement helper while retaining archive write/read-back validation before publication. Project schema, autosave and Android SAF export are unchanged.
- Failure truth: the async operation generation and existing success/failure status contract remain intact. Recoverable `Exception` becomes WAV failure status; fatal `Error` is rethrown and is not misreported as an ordinary export failure.
- TDD/review: missing helper and adapter APIs produced compile REDs. GREEN covers old-target preservation, first-write absence, temporary deletion, successful replacement/result retention, adapter use of a non-target path, actual renderer output and manual-project preservation. Review resolved fatal-error swallowing, post-publication cleanup ownership and success-with-invalid-WAV publication; final unresolved Standards/Spec findings are `0/0`.
- Validation: clean full gate `BUILD SUCCESSFUL in 5m18s`, 197 tasks (193 executed / 4 up-to-date). Android app 264 / 46 suites, shared Android/Desktop 66/66 / 13+13 suites, JVM-core 68 / 8 suites and Desktop 104 / 22 suites: 568 tests / 102 suites, failures/errors/skips 0. Lint debug/release each: fatal 0, errors 0, warnings 7. Configured validation 18 tasks and product-checkpoint public surface 440 PASS; closeout Python policy 59, current plus reachable-history public surface 440 and `git diff --check` PASS.
- Artifact read-back: debug APK 31,705,202 / `1F71851E832DAF3D5FE75A13E3E3900B17E71BCA2A8E7654998C1512BCFC1098`; androidTest APK 10,878,659 / `19002E0EBB2B62B599FAE7CF1738AC275B7D4CBEC610F0348D3B9C871A90E4AC`; unsigned release APK 24,208,500 / `E9DEB956D6F47FB24B89A26A8B6E70C5B941D7C93FDB9A3DAEB91FB78C2464BA`; Desktop JAR 349,674 / `C4B2F22F74F0FC4C1AE4126B80FAA92728898E9897213A71274008266EC32DC9`; Windows EXE 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`.
- Release/package policy: the exact unsigned APK passes package/version, manifest allowlists, non-debuggable, exported-component, 16-KiB alignment and `manifest_tool=aapt2` inspection. `--require-signed` rejects it with exit 1 as expected. Windows app-image is 405 files / 176,651,039 bytes with sorted slash-path/size/lowercase-file-hash manifest SHA-256 `53AB068CDDE342ECDB74E5C0C3D5A395AC9EAC9A8A8D3F86D3131EAC99D176E1`. CycloneDX 1.6 is `com.choplab:ChopLab:0.17.0`, 650 components / 651 dependencies; JSON is 1,581,101 bytes / `98C5846FC6B5DC4F1A6AA4F1EF9B550AA37086380F90CFC2692DB9D22DB9D767`, XML is 1,431,320 bytes / `5D23934C738BF0920E84D3357A4CA3C7462A6EB6C9639547C3591D5C37D37483`.
- Review/portfolio: parent PAD `work/PAD_CHOPLAB_GOAL_PORTFOLIO_WAVE13_20260827.md` and `work/PAD_CHOPLAB_GOAL_WAVE13_REVIEW_20260827.md`.
- Scope/gate: no model/package download, real audio asset, signing identity, key, secret, workflow, GitHub/Release, OAuth/provider, ADB/device or Human action occurred. Strongest fresh result is `LOCAL_PASS`; Android SAF mid-copy/provider behavior, filesystem/antivirus/network-share variants, actual export audition, `DEVICE_PASS`, `PROVIDER_PASS`, `PUBLIC_PASS` and `HUMAN_GO` remain separate.

## Historical local snapshot — 2026-08-27 Windows active-loop edit transaction

This was the clean Wave 12 local-branch product truth before GitHub integration. It makes a live Windows Beat-loop PAD edit audible and durable as one ordered transaction, without claiming physical endpoint behavior.

- Observed/read back at: `2026-08-27T02:05:48+09:00`.
- Product source: `codex/choplab-desktop-loop-edit-transaction-20260827@b8db4368511d8dd3578634bdd071be0da0f38b8a`, tree `a9b28c0d486cde7a7625258e10d97619d669fccf`, based on Wave 11 closeout `7e8603c0e9a64ff6cb4b74d4d244985494a7256c`. The dirty canonical preservation checkout and separate conflicted integration checkout remain untouched.
- User outcome: while the selected Windows Beat loop is active, KEY/TONE/LEVEL, trim, reverse and CHOKE changes start a replacement candidate before the PAD edit is committed to project/history/autosave. A recoverable output failure leaves the old PAD settings, loop ownership, history frontier and existing voice intact and reports that the edit was not applied. Loading/recording rejection and same-value edits do not retrigger audio.
- Adapter truth: `DesktopSamplerAudioEngine.triggerPad` now requires failed replacement startup to preserve existing voices. Java Sound prepares and owns the candidate Clip, cleans it on open/listener/start failure, starts it before retiring the snapshotted same-PAD/nonzero-CHOKE conflicts, and retires those conflicts only after successful startup. Different-PAD intentional polyphony remains eligible.
- Failure boundary: recoverable `Exception` becomes truthful session status; fatal `Error` is rethrown without committing state. Candidate-first replacement may briefly overlap the prior voice, so audible click/overlap/latency remains a physical Windows/Human gate.
- TDD/review: two controller behavior tests failed 2/2 against the old commit/stop/trigger ordering. Missing adapter preparation/start-order APIs produced compile REDs. GREEN covers preparation failure cleanup, startup failure preservation, success ordering, successful one-edit/Undo/no-op behavior, recording rejection and fatal-error propagation. Review found and resolved the Clip-open leak and fatal-error swallowing; final unresolved Standards/Spec findings are `0/0`.
- Validation: clean full gate `BUILD SUCCESSFUL` in 5m04s, 197 tasks (193 executed / 4 up-to-date). Android app 264 / 46 suites, shared Android/Desktop 66/66 / 13+13 suites, JVM-core 68 / 8 suites and Desktop 96 / 20 suites: 560 tests / 100 suites, failures/errors/skips 0. Lint debug/release each: fatal 0, errors 0, warnings 7. Configured validation 18 tasks and product-checkpoint public surface 435 PASS; closeout Python policy 59, current plus reachable-history public surface 435 and `git diff --check` PASS.
- Artifact read-back: debug APK 31,705,202 / `1F71851E832DAF3D5FE75A13E3E3900B17E71BCA2A8E7654998C1512BCFC1098`; androidTest APK 10,878,659 / `19002E0EBB2B62B599FAE7CF1738AC275B7D4CBEC610F0348D3B9C871A90E4AC`; unsigned release APK 24,208,500 / `E9DEB956D6F47FB24B89A26A8B6E70C5B941D7C93FDB9A3DAEB91FB78C2464BA`; Desktop JAR 341,486 / `8D26F12F3C67862AED4D6D1482341DCA3C109603BF84B2A3CFD01CBA11E74BFD`; Windows EXE 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`.
- Release/package policy: the exact unsigned APK passes package/version, manifest allowlists, non-debuggable, exported-component, 16-KiB alignment and `manifest_tool=aapt2` inspection. `--require-signed` rejects it with exit 1 as expected. Windows app-image is 405 files / 176,642,851 bytes with sorted slash-path/size/lowercase-file-hash manifest SHA-256 `EE98847088B77942ECD98F0BF1DD27F336A8D0421A0E22C0AD1D8B09BCC3A479`. CycloneDX 1.6 is `com.choplab:ChopLab:0.17.0`, 650 components / 651 dependencies; JSON is 1,581,101 bytes / `C0A45D14115A66C68D952AADE426664FEBC2F5543DFE4E49969009E7DC54007A`, XML is 1,431,320 bytes / `E6C526EC4257677C688AB3DED85BFE2EC62D6D10B8CCB12D7DBF02FC74155E13`.
- Review/portfolio: parent PAD `work/PAD_CHOPLAB_GOAL_PORTFOLIO_WAVE12_20260827.md` and `work/PAD_CHOPLAB_GOAL_WAVE12_REVIEW_20260827.md`.
- Scope/gate: no model/package download, signing identity, key, secret, workflow, GitHub/Release, OAuth/provider, ADB/device, recording or Human action occurred. Strongest fresh result is `LOCAL_PASS`; actual Java Sound driver failure, audible continuity, click/pop, temporary overlap, latency, route removal, Bluetooth, sleep/resume, Narrator, `DEVICE_PASS`, `PROVIDER_PASS`, `PUBLIC_PASS` and `HUMAN_GO` remain separate.

## Historical snapshot — 2026-08-27 consolidated PR #58 integration

This snapshot binds one review surface to the existing PR #58 branch. The integration starts at `d56244aa9c8208604341b08592db37dc3c3b816e`, retains exact `main@4f56a693b86540d1be13a6eb2153a3cf96ef9396`, and merges the clean heads of PR #64 (`9785d82`), PR #76 (`330d576`), PR #77 (`92db434`), Wave 10 closeout `600211f` and Wave 11 closeout `7e8603c`. It does not rewrite `v0.17.0` or claim a new release.

- Immutable integration product: `41a4bc37d2d84cadd5b5a787c62440bc76600e16`, tree `054db7e651c1eaeaa49aa523f3c58eda749bbff4`. Exact-main, prior PR #58, PR #64/#76/#77, Wave 10 and Wave 11 heads are all ancestors; `git fsck --connectivity-only --no-dangling` and `git diff --check` pass. A later receipt-only commit may advance the branch without changing these product bytes.
- Product scope: guided first entry and GATE ownership, Desktop autosave/recovery and source readiness, iOS recording-permission cancellation, Java Sound exact-once start failure cleanup, CHOKE loop-session ownership, A/B Song arrangement, 1/2-channel PCM identity, reverse-tail parity, bounded streaming decode and the focused all-16-step editor all remain in one ancestry. The focused editor uses portrait 4x4 or landscape 8x2, keeps every supported target at least 48 dp, preserves the selected PAD/BANK/page and returns explicitly to QUICK or the existing fine controls.
...
- Current local read-back: the full 184-task Android/shared/JVM/Desktop lint, test, assembly and Windows packaging gate passes. XML reports contain 622 tests / 105 suites with failures, errors and skips all zero; Python policy has 64 passing tests; configured validation and both current-tree and reachable-history public-surface scans pass at 439 candidates. Android debug/release lint each report fatal 0 / error 0 / warning 7. CycloneDX 1.6 verifies `com.choplab:ChopLab:0.17.0` with 650 components / 651 dependencies.
- Artifact boundary: Android release metadata is `0.17.0` / code `27`. The 24,274,036-byte release APK (`09ebe02b71949daf03aa22ef2968a2e7c58cf6170d419946451879ed8094ce4f`) passes manifest, permission/export, non-debuggable and alignment policy as an intentionally unsigned CI candidate; `--require-signed` rejects it with exit 1. Windows ProductVersion `0.17.0`, the packaged EXE and the 405-file deterministic app-image manifest read back successfully. No key, signer identity, certificate digest or secret was read or changed.
- Review and remote read-back: local Standards and Spec passes have unresolved findings 0 / 0. At `2026-08-27T02:54:28+09:00`, remote `main` remained `4f56a693`. Receipt `eb384f8` passed Windows `32995838663`, iOS `32995838174` and supply-chain `32995838455`; Android `32995838376` found the restored `クイック` node, then showed that the inherited fixture still called `performScrollTo()` on Wave 11's intentionally non-scroll focused editor. Test repair `59cfac9` removes only that invalid scroll action and retains the direct displayed-node assertion; 71-task AndroidTest compile/package passes locally. Fresh exact-head hosted workflows remain the merge gate.
- Gate ceiling: `LOCAL_PASS` candidate. Physical device, provider, signing, public release and `HUMAN_GO` remain separate. The annotated `v0.17.0` object remains immutable; the integrated product requires a new explicit version/tag decision before any binary Release.
...
- Observed at: `2026-08-25T00:10:38+09:00`. GitHub recorded immutable latest-main product `3b5dd59b9271ab9a8a4abce9f03b80301b753861` at `2026-08-24T15:10:27Z`; this observation and static read-back occurred 11 seconds later.
- Source state: PR #52 merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`; PR #62, PR #65, PR #66, PR #67, PR #68, PR #70, PR #71, PR #73, PR #74, PR #75 and the intervening bounded improvements are merged through exact `main@4f56a693b86540d1be13a6eb2153a3cf96ef9396`. The complete executable PR #58 repair is bound to reachable product commit `3b5dd59b9271ab9a8a4abce9f03b80301b753861`, tree `4985a8ce8b30c4554e86c1695d2349d0b076024a`, with parents prior PR docs head `17a959a92fb3a08edf83662c8440d16c2de70178` and exact main `4f56a69`. The final follow-up commit only binds documentation to this immutable source anchor. The integrated main side retains Desktop's shared 8–192 kHz import admission, terminal PAD sample retirement, transport step zero, shared import-name boundary, both recorder-start cancellation repairs, #74's reverse non-loop renderer correction and all #75 paths. A prior report names local build/runtime source `43d8ace6aa43f3eb6e3b9dc01ea74604ee600705` / tree `798212c33d1dcc3eb52ea79fb20e13b87a9b2d9a`, but that source is not in the current PR/main ancestry; its receipts remain externally unverifiable historical context.
...
- Shared navigation: `入れる → チョップ → ビート → 保存` remains the only workflow model. Font scale 1.2+ uses a simplified header, a two-by-two stage strip and multi-line status. CAPTURE scrolls for large text or compact landscape; large-text CHOP and BEAT bodies use explicit 48 dp-safe PAD heights and bounded scrolling so every control remains reachable. CHOP and ONE SHOT actions in those scroll bodies commit on completed tap, including an empty CHOP pad held stationary beyond the long-press timeout. A performance GATE waits through a 120 ms scroll-classification window, then consumes later movement and stays active until its initiating pointer reaches physical up, even if another pointer remains. Movement or leaving the PAD before activation cancels without a trigger. Every quick release receives an 80 ms minimum measured from the actual trigger, including releases just after delayed activation. Per-voice ownership tokens cover touch, keyboard, sequencer and programmatic triggers, so each physical/timer release targets its own GATE voice even after another input retriggers the same PAD. Movement after activation retains GATE ownership but cancels stationary trim recognition; a secondary pointer cannot retain the GATE or inherit its long-press trim. Parent cancellation before activation sends no PAD action, while pointer-node cancellation after activation conditionally releases trigger ownership exactly once. One-finger vertical movement over the CHOP waveform passes through only when the large-text parent scroller exists; without that ancestor it is consumed as a no-op drag so the sibling tap recognizer cannot seek or move a trim boundary on up. Horizontal, pinch and two-pointer rotation intent claim the waveform gesture; rotation is a visual no-op but still cancels the sibling tap. Non-scroll PADs retain press-down response. Compact landscape keeps transient status feedback in the header when the separate status strip is absent.
...
- Externally unverifiable historical gate report at `43d8ace`: a clean 191-task Gradle run after the landscape 48 dp correction and a later 184-task incremental cross-platform gate were recorded as PASS. The report lists shared Android host 25, shared Desktop 25, Android unit 234, JVM-core 52 and Desktop 77 tests; failures/errors/skips 0; Lint errors 0 / warnings 7; and policy gates over 389 candidates. None of those results is promoted into the current revision's gate.
- Review repair through `3b5dd59`: all code-applicable GitHub findings are addressed and all 31 corresponding review threads are resolved. Every paired GATE path retains a token: large-text deferred touch, normal-layout press-down touch, both CHOP grid layouts and Desktop keyboard. CHOP uses `capturePad` only for capture/one-shot behavior; assigned stopped-source GATE presses route through `triggerPadWithOwnership` / `releasePadIfOwned`. Android allocates the token only inside a reserved bounded-mailbox slot, stores it on the voice and gives sequencer voices tokens from the same lock-free per-PAD sequence; conditional release therefore fades only its own GATE voice. Desktop creates/starts Java Sound first, assigns the returned token to that exact active voice, and conditionally closes that voice even after a sequencer or other input starts a newer voice; failed start publishes no token. Real-pointer CHOP plus focused Android/Desktop ownership regressions bind stale-release exact targeting and failed-trigger/admission preservation. All prior pointer, minimum-preview, initiating-pointer and waveform rotation repairs remain. Exact #74 `PadPcmRenderer.kt` / test blobs `ffd0be2` / `315ec9b` and Desktop adapter test `e4ccb83` are preserved; `JavaSoundWavPlayer.kt` adds only per-voice ownership around the retained `renderDesktopPadPcm` force-loop seam. Reverse ONE_SHOT/GATE counting follows realtime cursor order, while LOOP/forceLoop retains the merged direct-position finite boundary. Current-container checks pass `git diff --check`, 39 Python tests, six Android XML parses and the exact-head 399-candidate public-surface scan. Prior head `b79f49d` passed all four workflows; current predecessor `17a959a` passed Windows `32741252127`, iOS `32741252051` and supply-chain `32741252093`, while Android `32741252150` passed static/unit/lint/debug/release phases and failed only instrumentation because the normal-font fixture requested `performScrollTo()` without a scroll ancestor. Product `3b5dd59` limits that request to font scale 1.2+, so fresh exact-head hosted execution remains required.
- #75 preservation: `MicrophoneRecorder.kt`, `RecorderWorkerStopTest.kt`, `RecordingSessionPolicyTest.kt` and shared `RecordingSession.kt` match exact `main@4f56a69` blobs `4fbbdab` / `4f29a59` / `a91ccc9` / `3a91cbb`. The merged ViewModel blob `3c28903` retains PR #58's engine-owned GATE tokens while adding #75's daemon native start, `stopAsync` lifecycle cancellation and exact STARTING confirmation. A late MIC/VOICE native-start callback cannot revive STOPPING/Idle or start the vocal Beat loop; pending STOP avoids framework `stop`, delegates `release`, applies the bounded wait and rejects replacement until unwind. Physical microphone timing and audio quality remain unverified.
- Externally unverifiable historical artifact report: debug APK 32,447,992 bytes / SHA-256 `EAF275AC902D955410E3D9C6B9FB39BF28AA196D4E89FD97E8CB981619F354FA`; androidTest APK 10,874,825 bytes / `77608CADDEBF300E0720E54E7537FD71FA081D40C4F94E9082A52E1DBFAC325B`; unsigned release APK 24,061,044 bytes / `A21DDEB26A5DBF4B0BFB7105E99BB09BF979305C6B2442FFFEA07A7E91879F67`; Windows app-image 405 files / 176,494,912 bytes / digest `2e8c568ec1746bae1a4500bd58e25b4d3751b5a0e1fbcc143e44e51639ecc773`, EXE SHA-256 `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`.
- Externally unverifiable historical runtime report at `43d8ace`: seven API 36 instrumentation tests, data-preserving installation, large-text captures/targets and packaged Windows CAPTURE/demo behavior were recorded as passing. Those bytes predate `3b5dd59`, are not reachable through the current PR/main ancestry, and prove neither the current gesture arbitration nor a current gate.
- Gate ceiling: the current review repair is source/static-policy validated and awaits hosted CI. No prior externally unverifiable receipt is used to establish `LOCAL_PASS` or a higher gate for these bytes. The physical Pixel was not connected, so current physical `DEVICE_PASS`, touch feel, TalkBack speech, listening/latency, recording, route loss, provider, binary Release and `HUMAN_GO` are not inferred.
...
## Previous snapshot — 2026-08-24 reverse PAD resampling tail merged

This snapshot records one bounded JVM/Desktop PAD-rendering correction merged as PR #74. It changes reverse non-loop host PCM frame selection plus focused no-device regressions and preserves the pre-existing LOOP renderer/playhead contract; Android realtime code, forward playback, DSP controls, project schema and Java Sound resource ownership are unchanged.
...
- Reproduced defect: reverse playback starts at `endFrame - 1`, but host allocation used the forward `ceil(rangeLength / sourceStep)`. A 64-frame 48→60 kHz fixture allocated 80 elements although only 79 reverse positions were valid, leaving one synthetic zero tail.
- Repair: reverse ONE_SHOT/GATE counting and rendering use the realtime `VoicePlaybackCursor` order. A count pass precedes exact allocation and the cursor resets for rendering. Reverse LOOP and Windows `forceLoop` retain the merged direct-position finite boundary and Desktop playhead mapping; forward playback remains unchanged.
- Focused regressions: 48→60 kHz requires 79 non-tail frames; 8→48 kHz / pitch −12 requires 12 frames; the reported two-frame pitch −5 fixture keeps reverse ONE_SHOT at 2 frames while LOOP/forceLoop retain the three-element finite render. Arbitrary-pitch loop phase and audible/physical Windows quality remain outside this repair.

## Previous snapshot — 2026-08-24 Desktop recorder startup cancellation merged

This snapshot records one bounded Desktop capture-lifecycle correction merged as PR #73. It changes only the `TargetDataLine` recorder and its host regression; audio format, recording limits, controller behavior, project schema and previously merged import/transport behavior are unchanged.

- Observed at: `2026-08-24T21:42+09:00`.
- Source state: merged `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; product repair `27283f8bc6ace63a27a9ea84e60db2abee5b4bd6` / tree `4ffc5f746f60cc67b71c29bb1f8a5b5db1a227ad` remains the runtime/test anchor.
...
- Source state: reachable integration product `e0d3fa1df5862bcfa038812bb12ecf6d2c45911e`, tree `1558c4a2331e8ef3a7b2809b38f264e671c188a6`, with parents prior clean PR head `d2c99fc2d4bb9c84bf6366a7f2568cca88294422` and merged `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`; PR #71 subsequently squash-merged as `main@dfcd9d8871f34ca5ed125c9a1113c6a4dd612887`. Current PR #58 product `3b5dd59b9271ab9a8a4abce9f03b80301b753861` retains all six shared/Android/Desktop product-test blobs exactly and integrates through `main@4f56a69`; the final evidence commit is documentation-only.
- Main preservation: #65 `DesktopTransport.kt` / `DesktopTransportTest.kt` remain exact `c92613c` / `073696e`; the controller and controller test retain #65 readiness/step-zero behavior while adding cross-input GATE ownership. #68's terminal-sample-before-retirement code remains intact and its parity test blob stays exact `9d51556`; `SamplerEngine.kt` additionally carries the reviewed per-voice ownership filter. The #70 provider/URI name-selection behavior and archive regression remain intact through the shared seam.
...
- Fresh local checks for the current follow-up: Python policy 39/39, public-surface 396 candidates, exact product/main blob comparisons, conflict-marker scan and `git diff --check` PASS. Gradle 9.7.1 remains unavailable locally, so fresh hosted Android/Windows/shared execution is required.
...
- Source state: reachable integration product commit `08fb123888fb840496d34e4ba7a586013e1305f6`, tree `dc9a9e8563e18168c5d20af9084ffaab01f0f742`, with parents prior exact PR head `5d630c8a769e4b840bba9914f59bc0ec1c705638` and merged `main@333088147cdc77932efc41b90a08eb37e1c1cf42`. PR #65 was subsequently squash-merged as `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`. Current PR #58 product `3b5dd59b9271ab9a8a4abce9f03b80301b753861` retains its `DesktopTransport.kt` and `DesktopTransportTest.kt` blobs exactly together with merged #66 timing, #67 Desktop import boundary, #68 realtime PAD retirement, #71 shared import names, #73/#75 recorder cancellation and #74 reverse-renderer behavior/test. Its controller/test preserve readiness/step-zero while adding exact Java Sound voice ownership; the final evidence commit is documentation-only.
...
- Source state: reachable product commit `3ad2bd9eda0561b0f1cf304b477ca726edd1becc`, tree `8272a51c4b537dd06ec02e0ff780e574babe4d46`, based directly on `main@3260f5cb560e2cbd2d245c7eee6f96ecb3540ddc`; PR #67 squash-merged it as `main@3de1cc5de2fc950ee7e24dfac29a2bc926cf1553` and the current PR #58 product retains those exact decoder/test files.
...
## Previous snapshot — 2026-08-24 fractional pattern-timing repair merged via PR #66
...
- Provider closeout: exact final head `7e5130f77b9c1fdd481f8226cbb3c44b71eaa9c0` received a clean Codex review. Supply-chain `32717689375`, Windows `32717689376`, iOS `32717689369` and Android `32717689383` all passed before merge.
...
- Gate ceiling: merged source plus exact-head hosted CI. Physical playback timing, audio perception, public release and `HUMAN_GO` remain unclaimed.

## Previous snapshot — 2026-08-24 constrained PAD gesture and semantics review repair merged via PR #62
...
- Source state: reachable product/verification commit `5b9592ff27608166a99fe77af0876ad1d6b917f5`, tree `97569b6a07fb74f9ee5b59101c0ea27059259a1b`, was reviewed through exact head `0e94698625f676573d42e74c52bf2394e1f24fd3` and squash-merged by PR #62 as `main@6b645ca5005f905e93c572edfc1d375d4a6eeeb5`.
...
- Provider checks: exact head `0e94698625f676573d42e74c52bf2394e1f24fd3` received a clean Codex review and passed Android, Windows, iOS and supply-chain workflows before merge. Local Python policy 39/39, public-surface 394, six Android XML parses and `git diff --check` also passed.
- Gate ceiling: source plus hosted CI only. The prior closeout's exact APK/emulator evidence remains historical and does not prove this new gesture arbitration, TalkBack speech, touch feel, audio onset, provider checks or `HUMAN_GO`.
...
## Integrated input — 2026-08-27 focused sixteen-step editor

Wave 11 replaces the cramped secondary Beat grid entry with one fixed, non-scrolling editor where all sixteen steps remain simultaneously visible and accurately targetable, without changing production or audio state. This input is now combined with the current PR #58 integration candidate.

- Observed/read back at: `2026-08-27T01:31:12+09:00`.
- Product source: `codex/choplab-step-accessibility-20260827@96118949fc8d8ec766715a6eb110d76523ac1095`, tree `d4e9b929f2e250e784bd2eeeb4dc309044bdb00c`, based on Wave 10 closeout `600211fa20b0cb3f4e1fdcaf0878d0aecb7166a3`. The dirty canonical preservation checkout remains untouched.
- User outcome: `並べる詳細 / STEPS` opens a dedicated editor with all steps 1–16 on one surface. Portrait is row-major 4×4; landscape is row-major 8×2. `PADへ戻る / QUICK` and `BPM・音色 / CONTROLS` provide explicit round trips, while the existing transport, tempo, tone and placement-preset controls remain available.
- Geometry truth: one shared pure policy subtracts the same content padding, fixed chrome, 48dp navigation header and grid gaps used by Compose. It rejects invalid or undersized bounds rather than rendering unsafe cells. Reference 360×640, 412×820, 640×360 and 1280×720 viewports pass at font scale 1.0/1.3/2.0. An inset-constrained 632×328 landscape control exposed 47.5dp with the normal gap; the focused compact-landscape gap is now scoped to 2dp and keeps cells at least 48dp.
- Interaction truth: one pure sixteen-cell presentation owns selected-PAD step keys, row/column order, active state, visual playhead and enabled/disabled descriptions. Compose calls the same `toggleStep(stepIndex)` controller seam as before. Workspace mode is local `rememberSaveable` presentation state; no project command, history, autosave, schema, engine, DSP, WAV or export field changed.
- TDD/review: missing geometry/mode and cell-presentation APIs produced intended compile REDs. The inset negative control then produced an assertion RED. Standards review resolved the inset failure and an unnecessary public-API expansion; final unresolved Standards/Spec findings are `0/0`.
- Validation: clean full gate `BUILD SUCCESSFUL` in 4m13s, 197 tasks (196 executed / 1 up-to-date). Android app 264 / 46 suites, shared Android/Desktop 66/66 / 13+13 suites, JVM-core 68 / 8 suites and Desktop 89 / 19 suites: 553 tests / 99 suites, failures/errors/skips 0. Lint debug/release each: fatal 0, errors 0, warnings 7. Configured validation 18 tasks, Python policy 59, reachable-history public surface 433 and `git diff --check` PASS.
- Artifact read-back: debug APK 31,705,202 / `1F71851E832DAF3D5FE75A13E3E3900B17E71BCA2A8E7654998C1512BCFC1098`; androidTest APK 10,878,659 / `19002E0EBB2B62B599FAE7CF1738AC275B7D4CBEC610F0348D3B9C871A90E4AC`; unsigned release APK 24,208,500 / `E9DEB956D6F47FB24B89A26A8B6E70C5B941D7C93FDB9A3DAEB91FB78C2464BA`; Windows EXE 449,024 / `05BA300784A2B98197200A7B5AFCEDD70B62913DB71C1971B23A5E9785281630`, ProductVersion `0.17.0`.
- Release/package policy: the exact unsigned APK passes package/version, manifest allowlists, non-debuggable, exported-component, 16-KiB alignment and `manifest_tool=aapt2` inspection. `--require-signed` rejects it with exit 1 as expected. Windows app-image is 405 files / 176,638,021 bytes with sorted slash-path/size/lowercase-file-hash manifest SHA-256 `E810F81D08ED4A3C6FBF33F987F9B1C0694EFA844447AF6208693301DD1EA050`. CycloneDX 1.6 is `com.choplab:ChopLab:0.17.0`, 650 components / 651 dependencies, 1,581,101 bytes / `FF210B222F9CF2C12E6975A6AAA7DBCA5BAD663F1516A3598019BF7143953598`.
- Review/portfolio: parent PAD `work/PAD_CHOPLAB_GOAL_PORTFOLIO_WAVE11_20260827.md` and `work/PAD_CHOPLAB_GOAL_WAVE11_REVIEW_20260827.md`.
- Scope/gate: no signing identity, key, secret, workflow, GitHub/Release, OAuth/provider, ADB/device, recording or Human action occurred. Strongest fresh result is `LOCAL_PASS`; physical touch accuracy, one-hand comfort, TalkBack/Narrator speech and focus order, `DEVICE_PASS`, `PROVIDER_PASS`, `PUBLIC_PASS` and `HUMAN_GO` remain separate.
