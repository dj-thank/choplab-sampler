...
- Product source: reachable two-parent commit `7c57fb46d2867c5bc7739fcd4f92c9a0bbd73b24`, tree `085c809feb7e510278f9a1e1959c700017b6713f`, advancing prior PR docs head `44704a5b78eebb814141f53fce0e08e919b25f72` and exact main `029500ac63fe521814530acf4d70cab78365c9fd`. GitHub recorded the product at `2026-08-24T14:46:14Z`; the documentation observation at `2026-08-24T23:46:25+09:00` occurred 11 seconds later. PR #52 and PRs #62, #65, #66, #67, #68, #70, #71, #73 and #74 are integrated. The #65 Desktop readiness/step-zero, #67 8–192 kHz admission, #68 terminal-sample behavior/test, #71 import-name boundary, #73 recorder cancellation and #74 reverse renderer/test/force-loop behavior are retained.
...
- Hosted feedback and repair: Android runs `32730801241` and `32732266959` exposed two fixture-only timing/type gaps, repaired by `0659041` and `643546b`. Prior exact head `b79f49d` then passed Android `32734114319`, Windows `32734114246`, iOS `32734114273` and supply-chain `32734114286`. Superseded head `44704a5` passed Windows `32739516512` and supply-chain `32739516361` before exact review identified the CHOP callback gap. Those receipts do not validate product `7c57fb4`; all workflows and exact-head Codex review must rerun.
