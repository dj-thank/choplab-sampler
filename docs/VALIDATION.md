...
- full host gate: 124 tests / failures 0 / errors 0 / skipped 0; Lint 0 errors / 11 advisories; assemble PASS
...
- local APK: versionCode 15 / versionName 0.11.0; 31,520,134 bytes; SHA-256 `699CD8EA834E3630A2994E32DCC925C4B4A0B7D970A3629AA09EDA59E924B580`
...
- independent read-only review found the remaining P1 ViewModel optimism and then a P2 pending-start toggle gap; start/stop now preserve the last audio-thread-applied value, pending copy explains when PAD capture is safe, a second tap cancels pending playback, and the transition layers are covered by the 124-test gate
