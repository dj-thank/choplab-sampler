...
- Product source: reachable commit `830e12a9c68b8e53fdd2b67adb270c2b4ada823b`, tree `6d9f921bdb2a375ab275b1182a65ba38fd2f1d6d`, advancing the product lineage rooted at exact merged `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the later evidence commit changes documentation only. Renderer/test blobs are `2ab9a60e18f6d0db763ae3b5649b6e56cbcbb89a` / `689c9890d6bff3592cc3cb9dfbec9ef3e2bef96b`.
...
- Local PASS: arithmetic reproduction; Python policy tests 39/39; public-surface current/history over 395 candidates; conflict-marker scan; `git diff --check`. Focused `:jvm-core:test` could not start because Gradle 9.7.1 is not cached and the distribution host is unreachable.
