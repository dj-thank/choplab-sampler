...
- Product source: reachable commit `0659041c019d21b369d17efdcde17380d415f61d`, tree `bce74d2ccd7ed30f4b56a840d0babc119ac56d9d`; its ancestry contains two-parent integration `23166b80fbd3fe7c31fe9571a99a4344178a7b3e` with exact main-side parent `a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`. PR #52 and PRs #62, #65, #66, #67, #68, #70, #71 and #73 are therefore integrated. The final follow-up commit is a documentation-only anchor update. The #65 Desktop readiness/step-zero contract, #67 Desktop 8–192 kHz admission, #68 realtime terminal-sample source/tests, #71 shared Android/Desktop import-name source/tests/docs and #73 recorder-start cancellation source/tests/docs are retained.
...
- Hosted feedback and repair: Android run `32730801241` on prior head `2d24b63` passed offline validation, unit tests, lint, debug/release builds and release inspection. Its emulator step stopped at `:app:compileDebugAndroidTestKotlin`: `FirstScreenFlowDeviceTest.kt:463` passed integer `width` to float `Offset`. Product `0659041` uses `width.toFloat()` for that real-pointer displacement; the behavior and distance are unchanged. Windows `32730801322`, iOS `32730801389` and supply-chain `32730801251` passed on the prior head, but all workflows must rerun for the repaired exact head.
