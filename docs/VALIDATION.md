...
- Product source: reachable integration product `3e2cd38ff204d9067c6e6960a2a63e59e6cc32e7`, tree `01d1062120e3bc4438b5b5ac4a6b0132c0230d1d`, with parents prior exact PR head `1c4bf4c43edfeb2ecd71359851ed8df747575626` and merged `main@3de1cc5de2fc950ee7e24dfac29a2bc926cf1553`. It is a candidate, not a merged-main revision; its four Desktop product/test blobs remain exact, and merged #66 timing plus #67 Desktop import-boundary source/tests/docs are retained.
...
- Prior exact-head evidence: remote PR head `1c4bf4c43edfeb2ecd71359851ed8df747575626` received a clean exact-head Codex re-review. Workflow runs `32719507840` (Android), `32719507923` (Windows), `32719507827` (iOS), and `32719507878` (supply chain) all completed successfully.
