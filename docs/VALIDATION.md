...
- Product source: reachable commit `6bb8045775e24c229b42a88d67be0815df231b74`, tree `f2f9912c049c899f685a3ab89cdc31ae0cadbb2a`, directly advancing exact merged `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the later evidence commit changes documentation only. Renderer/test blobs are `c564487b5bdcc03fcb039823d07b7b79dfe2181e` / `7c38837f9123821235c7a5752034e9586b2a13a8`.
...
- Repair contract: reverse allocation uses `floor((end - start - 1) / sourceStep) + 1`, matching its last-included-frame origin. Forward allocation and all PCM interpolation, tone, gain and boundary-envelope calculations are unchanged.
