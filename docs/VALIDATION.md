...
- Android artifacts after the hosted-copy repair: debug APK 32,900,764 bytes / `f798f68cc7577883adc2b309fcb95206e09efb19321436faca0a50b378fc022b`; androidTest APK 11,173,362 / `862f4f9ad397bb88ec576028ad499f8dc043b2fe6edbf75103afb7428d5fbe0a`; unsigned release APK 24,274,036 / `09ebe02b71949daf03aa22ef2968a2e7c58cf6170d419946451879ed8094ce4f`. Release metadata is `0.17.0` / code 27. Manifest/security/alignment verification exits 0 as an unsigned candidate; the `--require-signed` negative control exits 1.
...
- Wave 11 hosted feedback: exact receipt `8ee2f26` passed Windows `32993910045`, iOS `32993910073` and supply-chain `32993910026`. Android `32993909963` passed policy, offline validation, unit/lint/build and release inspection, then failed one of 29 API 36 tests because `largeTextCanReachDemoAndBothBeatSurfacesByScrolling` could not find the established Japanese `クイック` return action after opening `並べる詳細`. Product `41a4bc3` changes only `PADへ戻る / QUICK` to `クイックへ戻る / QUICK`; the existing instrumentation assertion is unchanged. The focused 58-task compile/shared/unit gate and the full 184-task gate both pass after this repair; XML remains 622 / 105 with failures/errors/skips 0.
