...
- Product source: reachable commit `8a2a736fbd28c8d9ab50d45a21cdc76d926f06d5`, tree `e04dd1840a91855ddc6e1ed491c250f2184b5b0b`, advancing the product lineage rooted at exact merged `main@a0b356c2e5820b7f9a8288ebcdd555c19e0cb6b5`; the later evidence commit changes documentation only. Renderer/test blobs are `ffd0be29db89d9ec75d553ab88c6d2d832e77e75` / `6ea1b4e1525d92ea5e1cca62e76bca8825ce017c`; Desktop adapter/test blobs are `95a69a20e1e7c1667bcfa0f759d902eea73327fc` / `96be34a61f043008ac98f184ff5ae78b2443b1bf`.
...
- Regressions: `reverseResamplingStopsAtTheSameFrameAsTheRealtimeCursor` requires 79 realtime/host frames and a nonzero last valid PCM. `reverseOneShotUsesCursorRoundingAtTheStartBoundary` binds the review's two-frame 8→48 kHz / pitch −12 case to 12 frames. `reverseLoopKeepsTheLegacyRenderBoundary` requires the same pad to keep main's four-element LOOP render and terminal boundary zero rather than cursor-wrapped PCM. `JavaSoundWavPlayerTest.forceLoopKeepsTheLegacyRenderBoundaryWhenThePadIsOneShot` binds the adapter to the same legacy boundary without opening audio hardware. Arbitrary-pitch loop phase continuity and playhead parity are explicitly outside this non-loop repair.
