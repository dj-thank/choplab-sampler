...
- Product source: reachable two-parent commit `79c2a8bee5858641fcba14ea746e979c11c4b6c5`, tree `ba39013b5589bfe29eab2f77903641962df96acc`; PR #52 is merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`, and PRs #62, #65, #66, #67, #68 and #70 are merged through exact `main@3072eedd84b357f4ccd22c611dcc7b7f22f92874`, which is the product commit's main-side parent. The final follow-up commit is a documentation-only anchor update. The #65 Desktop readiness/step-zero runtime and tests, #67 Desktop 8–192 kHz admission, #68 realtime terminal-sample source/tests and #70 Android import-name source/tests/docs are retained.
...
- Current-container checks: `git diff --check` PASS; Python policy suite 39/39 PASS; public-surface scan 394 candidates PASS; all six Android XML files parse successfully; #65, #68 and #70 runtime/test/plan blobs match exact `main@3072eedd`.
