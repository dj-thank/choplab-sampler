...
- Product anchor: `e381a7fdeb366fc648b7eb661d5cfa57b5585b48`, tree `6f83d930de9b66a121ed11438de92ed8e8c06dfe`. Every integration parent and exact `main@4f56a693b86540d1be13a6eb2153a3cf96ef9396` is an ancestor; connectivity and `git diff --check` pass.
...
- Android artifacts: debug APK 32,900,756 bytes / `280d73263cf9db5995cb09b086c79df0628a7b1218853d1aa201bf116a809349`; androidTest APK 11,173,362 / `862f4f9ad397bb88ec576028ad499f8dc043b2fe6edbf75103afb7428d5fbe0a`; unsigned release APK 24,274,036 / `89cf3234b34bc118dc65a223b3c057726eee83bc04e628433b31b5b44150a458`. Release metadata is `0.17.0` / code 27. Manifest/security/alignment verification exits 0 as an unsigned candidate; the `--require-signed` negative control exits 1.
- Windows artifacts: `ChopLab.exe` 449,024 bytes / `05ba300784a2b98197200a7b5afcedd70b62913db71c1971b23a5e9785281630`, ProductVersion `0.17.0`; Desktop JAR 375,382 / `6f711f5b6990e696cda564f8a89e8e6caf42db68c64c3e6fbc23fe746f2ae5b8`; app-image 405 files / 176,728,875 bytes / deterministic manifest `2efee386aff01bfc537156ad00cec5d67186e72d5ebc40557a17afdb44a2e00a` using slash-normalized relative path, decimal size and lowercase file SHA-256 with one LF-terminated record per file.
