...
- Product source: reachable two-parent commit `c2e3aeea8d3cae18372b5ed99917eb95beb8d283`, tree `ec8702bc0f9350f90427a9d83a630105acb95dbe`; PR #52 is merged at `main@495ddc9dfac02a9e72160c637f65d2b53d6829ce`, PRs #62, #66, #67, #68 and #70 are merged through exact `main@333088147cdc77932efc41b90a08eb37e1c1cf42`, and that exact main revision is the product commit's main-side parent. The final follow-up commit is a documentation-only anchor update. The #67 Desktop 8–192 kHz admission, #68 realtime terminal-sample source/tests and #70 Android import-name source/tests/docs are retained.
...
- Current-container checks: `git diff --check` PASS; Python policy suite 39/39 PASS; public-surface scan 394 candidates PASS; all six Android XML files parse successfully; #68 and #70 runtime/test/plan blobs match exact `main@33308814`.
