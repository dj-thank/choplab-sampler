...
- Product anchor: `1d0e850507e9e62d36cbffed8c20a3a7950931d1`, tree `f4f69b7498f8ccad7d91d1782f2d917b3497c1c8`. Every integration parent and exact `main@4f56a693b86540d1be13a6eb2153a3cf96ef9396` is an ancestor; connectivity and `git diff --check` pass.
...
- Full cross-platform gate: `:shared:testAndroidHostTest :shared:desktopTest :app:testDebugUnitTest :app:lintDebug :app:lintRelease :app:assembleDebug :app:assembleDebugAndroidTest :app:assembleRelease :jvm-core:test :desktop:test :desktop:packageWindows` completed successfully in 1m23s; 184 tasks (128 executed / 56 up-to-date). XML read-back: Android 275 / 47 suites, shared 132 / 26, JVM-core 74 / 8, Desktop 125 / 20; total 606 / 101, failures/errors/skips 0. Lint debug and release each report fatal 0 / error 0 / warning 7.
- Policy and supply chain: configured validation passes public surface, executable modes, 18 Gradle tasks, six XML resources, wrapper digest and UTF-8 checks. Python policy 64 passes. Current-tree and reachable-history public-surface scans each accept 435 candidates. CycloneDX 1.6 verification reports 650 components / 651 dependencies; SBOM is 1,581,101 bytes / SHA-256 `9fb3e143b2bf5a38c3ba0b16586af308024b4ed9b5bcd238ca52179bfaa93d59`.
...
- Android artifacts: debug APK 31,754,354 bytes / `40ada39352363ed3cf2a70dde2e95f2f153d8bcf7770d97cb49caeaf4398e92e`; androidTest APK 10,996,323 / `9827bd168d43340d7692816fc6479661adc7ad077b83e9492bc50e61d9b2f120`; unsigned release APK 24,241,268 / `e51805f24d87a8f3776a5db813efeefa5a33bc6cbadf8f1bd31dac01e634e6d4`. Release metadata is `0.17.0` / code 27. Manifest/security/alignment verification exits 0 as an unsigned candidate; the `--require-signed` negative control exits 1.
- Windows artifacts: `ChopLab.exe` 449,024 bytes / `05ba300784a2b98197200a7b5afcedd70b62913db71c1971b23a5e9785281630`, ProductVersion `0.17.0`; Desktop JAR 375,382 / `6f711f5b6990e696cda564f8a89e8e6caf42db68c64c3e6fbc23fe746f2ae5b8`; app-image 405 files / 176,706,397 bytes / deterministic manifest `ff7e11203a0d06019bc7adcb032264523933110f40554889f32c1fefb16cc474`.
...
- Remaining gate: push the exact receipt head to the existing PR #58 branch, require fresh exact-head Android/Windows/iOS/supply-chain workflows, then merge only if the PR remains clean. No tag, release, signing identity, device or provider boundary has been touched. Existing `v0.17.0` cannot represent these later product bytes and must not be rewritten.
