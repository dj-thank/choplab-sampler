...
- Integration base: merged `main@592b4ee777b32c9ce84d771166d04628cd104818`; integrated closeout: `9043af2f582b4f8965ce973ab007d79de4d9324b`, containing Wave 12 product `b8db4368511d8dd3578634bdd071be0da0f38b8a` and Wave 13 product `ffe1bbdf59d0645652c3f8556fb6f601e5218670`.
...
- Required fresh proof: focused desktop/JVM compilation and tests, the full cross-platform/package gate, XML and artifact read-back, Python policy, current/history public-surface scan, two-axis review, then exact-head Android/Windows/iOS/supply-chain workflows. Parent receipts are inputs, not merged-head proof.
- Gate ceiling before those checks: local integration candidate only. No device, signing, tag, Release, provider or Human claim is inherited.
