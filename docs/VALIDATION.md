...
- Product source: reachable two-parent commit `8ba549c8a93d416e32d504c2c91f0809705a48d3`, tree `1fb4485b83f018ad2a1667374111fb7f654548a5`, advancing prior PR docs head `aa790a820ac79c8c65b7694bebd61cbcdcd1a1b1` and exact main `029500ac63fe521814530acf4d70cab78365c9fd`. GitHub recorded the product at `2026-08-24T14:10:50Z`; the documentation observation at `2026-08-24T23:10:57+09:00` occurred 7 seconds later. PR #52 and PRs #62, #65, #66, #67, #68, #70, #71, #73 and #74 are integrated. The #65 Desktop readiness/step-zero, #67 8–192 kHz admission, #68 terminal-sample behavior/test, #71 import-name boundary, #73 recorder cancellation and #74 reverse renderer/test/adapter blobs are retained.
...
- Current-container checks: `git diff --check` PASS; Python policy suite 39/39 PASS; public-surface scan 398 candidates PASS; all six Android XML files parse successfully. All six #71 product-test blobs, #73 recorder runtime/test and #74 renderer/test/adapter blobs match exact `main@029500a`. #68 terminal-sample behavior and its exact parity test remain; `SamplerEngine.kt` adds reviewed per-voice ownership. #65 transport/runtime test remain exact while controller/test preserve step-zero and add trigger-failure ownership.
- Hosted feedback and repair: Android runs `32730801241` and `32732266959` exposed two fixture-only timing/type gaps, repaired by `0659041` and `643546b`. Prior exact head `b79f49d` then passed Android `32734114319`, Windows `32734114246`, iOS `32734114273` and supply-chain `32734114286`. That head predates the ownership product `74f2cee` and latest-main integration `8ba549c`; all workflows and exact-head Codex review must rerun.
