...
- Product/policy source: reachable integration policy commit `c2e50409803d5fc990e18f8cff92e3a454485d2f`, tree `3ebef0d86ea7b200bf9cb292507e31de93b35e3f`, with parents prior exact PR head `0b7153ed3763c2f4c764f2dd8f4e18a382009d91` and merged `main@dfcd9d8871f34ca5ed125c9a1113c6a4dd612887`; this section is in a later documentation-only commit. Merged #65/#68/#70/#71 runtime, tests and documentation are retained.
- Contract: safe-named UTF-8 ZIP member text and archive/member comments in the current tree and reachable historical ZIP blobs are scanned with the ordinary secret patterns, including token-shaped content accompanied by controls. Historical candidates are derived from NUL-delimited raw path/blob records before blob-ID deduplication. The scanner rejects more than 4,096 entries before member opening, payload-bearing directory entries, members above 512 KiB, archives above 4 MiB scanned text and declared compression above 100:1. History is capped at 128 unique ZIP blobs, 16 MiB each and 64 MiB aggregate; exceeding any cap fails the gate.
